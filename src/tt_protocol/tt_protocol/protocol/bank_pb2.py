...
Balances = _reflection.GeneratedProtocolMessageType('Balances', (_message.Message,), {
  ...
  'AmountsEntry' : _reflection.GeneratedProtocolMessageType('AmountsEntry', (_message.Message,), {
...
AccountsBalancesRequest = _reflection.GeneratedProtocolMessageType('AccountsBalancesRequest', (_message.Message,), {
...
AccountsBalancesResponse = _reflection.GeneratedProtocolMessageType('AccountsBalancesResponse', (_message.Message,), {

  'BalancesEntry' : _reflection.GeneratedProtocolMessageType('BalancesEntry', (_message.Message,), {
...
AccountHistoryRequest = _reflection.GeneratedProtocolMessageType('AccountHistoryRequest', (_message.Message,), {
...
AccountHistoryResponse = _reflection.GeneratedProtocolMessageType('AccountHistoryResponse', (_message.Message,), {
...
StartTransactionResponse = _reflection.GeneratedProtocolMessageType('StartTransactionResponse', (_message.Message,), {
...
_BALANCES_AMOUNTSENTRY._options = None
_ACCOUNTSBALANCESRESPONSE_BALANCESENTRY._options = None
