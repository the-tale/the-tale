...
class FEATURE(DjangoEnum):
    ...
    records = (('FEATURE_0', 0, 'гигант', 'гигант', False),
               ('FEATURE_1', 1, 'борода: средняя', 'средняя борода', False),
               ...
               ('FEATURE_29', 29, 'кожа: тёмная', 'тёмная кожей', False),
               ...
               ('FEATURE_36', 36, 'рога: маленькие', 'маленькие ножки', False),
...
class SIZE(DjangoEnum):
    records = (('SIZE_0', 0, 'вдвое выше человека'),
               ('SIZE_1', 1, 'длина 4 метра'),
               ('SIZE_2', 2, 'длина 8 метров'),
               ('SIZE_3', 3, 'меньше гоблина'),
               ('SIZE_4', 4, 'полтора человека'),
               ('SIZE_5', 5, 'с быка'),
               ('SIZE_6', 6, 'с волка'),
               ('SIZE_7', 7, 'с гоблина'),
               ('SIZE_8', 8, 'с лошадь'),
