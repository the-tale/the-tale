...
# SIMULTANEOUS_EMISSARY_EVENTS_DELTA = int(1)
...
MAXIMUM_FIGHTERS = FIGHTERS_TO_EMISSARY * MAXIMUM_EMISSARIES
...
FIGHTERS_MAXIMUM_LEVEL_STEPS = MAXIMUM_FIGHTERS - INITIAL_FIGHTERS_MAXIMUM
...
FIGHTERS_MAXIMUM_LEVELS_TIME = _fighters_generator.series(n=FIGHTERS_MAXIMUM_LEVEL_STEPS, border=EXPECTED_LEVELING_TIME)
...
FIGHTERS_MAXIMUM_LEVELS_EXPERIENCE = _experience_levels(FIGHTERS_MAXIMUM_LEVELS_TIME)
