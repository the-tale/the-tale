...
MAXIMUM_HEALTH: int = 5000
MAXIMUM_HEALTH_DELTA: int = 750

NORMAL_DAMAGE_TO_HEALTH: int = 1000
DAMAGE_TO_HEALTH_DELTA: int = 100

# в час
HEALTH_REGENERATION_MIN: int = int(math.ceil(0.10 * NORMAL_DAMAGE_TO_HEALTH / 24))
HEALTH_REGENERATION_MAX: int = int(math.ceil(0.35 * NORMAL_DAMAGE_TO_HEALTH / 24))
