...
STANDART_LIMITED_TASK_POINTS_MINIMUM = int(math.ceil(clans_constants.MEMBERS_TO_EMISSARY / 2))
STANDART_LIMITED_TASK_POINTS_MAXIMUM = int(3 * clans_constants.MEMBERS_TO_EMISSARY)
