...
# в час
HEALTH_REGENERATION_MIN = int(math.ceil(0.25 * NORMAL_DAMAGE_TO_HEALTH / 24))
HEALTH_REGENERATION_MAX = int(math.ceil(1.5 * NORMAL_DAMAGE_TO_HEALTH / 24))
...
MAXIMUM_ATTRIBUTE_MAXIMUM = NORMAL_ATTRIBUTE_MAXIMUM + ATRIBUTE_MAXIMUM_DELTA
...
_ATTRIBUT_INCREMENT_DELTA = ((NORMAL_ATTRIBUTE_MAXIMUM - INITIAL_ATTRIBUTE_VALUE) /
                             (clans_constants.SIMULTANEOUS_EMISSARY_EVENTS * EXPECTED_LEVELING_TIME))
ATTRIBUT_INCREMENT_DELTA = int(math.ceil(_ATTRIBUT_INCREMENT_DELTA))

ATTRIBUT_INCREMENT_BUFF = int(7)

BUFFED_ATTRIBUT_INCREMENT_DELTA = ATTRIBUT_INCREMENT_DELTA + ATTRIBUT_INCREMENT_BUFF
DEBUFFED_ATTRIBUT_INCREMENT_DELTA = ATTRIBUT_INCREMENT_DELTA - ATTRIBUT_INCREMENT_BUFF
...
MAX_EXPERIENCE_PER_EVENT = int(math.ceil(clans_constants.EXPERIENCE_PER_EVENT / 24 * 2))
...
EXPECTED_ATTRIBUTES_INCREMENT_FROM_EVENT = 2 * ATTRIBUT_INCREMENT_DELTA
