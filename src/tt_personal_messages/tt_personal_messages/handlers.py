...
@handlers.protobuf_api(personal_messages_pb2.NewMessagesNumberRequest)
...
@handlers.protobuf_api(personal_messages_pb2.ReadMessagesRequest)
...
@handlers.protobuf_api(personal_messages_pb2.SendMessageRequest)
...
@handlers.protobuf_api(personal_messages_pb2.HideMessageRequest)
...
@handlers.protobuf_api(personal_messages_pb2.HideAllMessagesRequest)
...
@handlers.protobuf_api(personal_messages_pb2.HideConversationRequest)
...
@handlers.protobuf_api(personal_messages_pb2.RemoveOldMessagesRequest)
...
@handlers.protobuf_api(personal_messages_pb2.GetMessagesRequest)
...
@handlers.protobuf_api(personal_messages_pb2.GetConversationRequest)
...
@handlers.protobuf_api(personal_messages_pb2.GetMessageRequest)
...
@handlers.protobuf_api(personal_messages_pb2.GetContactsRequest)
...
@handlers.protobuf_api(personal_messages_pb2.DebugClearServiceRequest)
