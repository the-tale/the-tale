...
class BILL_TYPE(DjangoEnum):
    ...
    records = ( ('PLACE_RENAMING', 0, u'переименование города',                      1.5 * c.PLACE_STABILITY_UNIT, True),
                ...
                ('PERSON_ADD_SOCIAL_CONNECTION', 14, u'добавить социальную связь',   0.6 * c.PLACE_STABILITY_UNIT, True),
                ('PERSON_REMOVE_SOCIAL_CONNECTION', 15, u'удалить социальную связь', 0.6 * c.PLACE_STABILITY_UNIT, True) )
