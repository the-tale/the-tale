...
class PersonRemoveSocialConnection(BaseBill):
    ...
    DESCRIPTION = 'Социальную связь между Мастерами можно удалить, помирив конкурентов или рассорив партнёров. Создать запись может только Хранитель героя из ближнего круга одного из Мастеров. Герой должен быть в ближнем круге на момент создания записи и/или её редактирования.'
