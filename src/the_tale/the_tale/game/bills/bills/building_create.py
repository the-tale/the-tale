...
class BuildingCreate(base_person_bill.BasePersonBill):
    ...
    DESCRIPTION = 'Возводит здание, принадлежащее выбранному Мастеру (и соответствующее его профессии). Один Мастер может иметь только одну постройку. О типах зданий можно узнать в <a href="/guide/persons">Путеводителе</a>. '
