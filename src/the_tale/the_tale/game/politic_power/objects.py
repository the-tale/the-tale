...
class InnerCircle:
    __slots__ = ('rating', 'powers', 'size', 'positive_heroes', 'negative_heroes', 'positive_heroes_number', 'negative_heroes_number')
    ...
    def __init__(self, rating, size):
        ...
        self.positive_heroes_number = len(self.positive_heroes)
        self.negative_heroes_number = len(self.negative_heroes)
