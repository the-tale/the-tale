...
class RISK_LEVEL(rels_django.DjangoEnum):
    ...
    records = (('VERY_HIGH', 0, 'очень высокий', 0.70, 1.30, 2.0, 2.00, 0.0, 'Больше опыта и наград за задания, +200% к влиянию и денежным наградам за задания. При поиске пути герой полностью игнорирует безопасность региона.'),
               ('HIGH', 1, 'высокий', 0.85, 1.15, 1.0, 1.00, 0.5, 'Немного больше опыта и наград за задания, +100% к влиянию и денежным наградам за задания. При поиске пути герой ценит транспорт региона больше безопасности'),
               ('NORMAL', 2, 'обычный', 1.00, 1.00, 0.0, 0.00, 1.0, 'Никакого влияния на опыт, награды и влияние героя. При поиске пути герой одинаково учитывает и транспорт и безопасность региона.'),
               ('LOW', 3, 'низкий', 1.15, 0.85, -1.0, -1.00, 2.0, 'Немного меньше опыта и наград за задания, -100% к влиянию и денежным наградам за задания. При поиске пути герой ценит безопасность региона больше транспорта.'),
               ('VERY_LOW', 4, 'очень низкий', 1.30, 0.70, -2.0, -2.00, 4.0, 'Меньше опыта и наград за задания, -200% к влиянию и денежным наградам за задания. При поиске пути герой оценивает безопасность региона значительно сильнее транспорта.'))
...
class MODIFIERS(rels_django.DjangoEnum):
    ...
    records = (('INITIATIVE', 0, 'инициатива', lambda: 1.0),
               ...
               ('POWER_TO_FRIEND', 16, 'бонус к влиянию на друга', lambda: 0.0),
               ('POWER_TO_ENEMY', 17, 'бонус к влиянию на врага', lambda: 0.0),
               ...
               # ('MAX_ENERGY', 30, 'бонус к максимуму энергии', lambda: 0),
