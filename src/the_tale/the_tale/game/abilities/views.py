...
class AbilitiesResource(utils_resources.Resource):
    ...
    @old_views.validate_argument('ability', argument_to_ability, 'abilities', 'Неверный идентификатор способности')
    ...
    @old_views.validate_argument('battle', int, 'abilities', 'Неверный идентификатор сражения')
    @old_views.handler('#ability', 'api', 'use', method='post')
