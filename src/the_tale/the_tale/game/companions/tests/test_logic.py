...
class LogicTests(utils_testcase.TestCase):
    ...
    def test_create_companion_record(self):
        name = game_names.generator().get_test_name()
        ...
        self.assertEqual(companion_record.features, frozenset((tt_beings_relations.FEATURE.FEATURE_1, tt_beings_relations.FEATURE.FEATURE_3)))
    ...
    def test_create_companion_record__set_state(self):
        companion_record = logic.create_companion_record(utg_name=game_names.generator().get_test_name(),
                                                         description='description',
                                                         type=tt_beings_relations.TYPE.random(),
                                                         max_health=10,
                                                         dedication=relations.DEDICATION.random(),
    ...
    def test_create_companion_record__linguistics_restriction_setupped(self):
        ...
        self.assertEqual(sync_restriction.call_args_list, [mock.call(group=linguistics_restrictions.GROUP.COMPANION,
                                                                     external_id=companion_record.id,
                                                                     name=companion_record.name)])

    def test_update_companion_record(self):
        old_name = game_names.generator().get_test_name(name='old')
        new_name = game_names.generator().get_test_name(name='new')
    ...
    def test_enable_companion_record(self):
        ...
        companion_record = logic.create_companion_record(utg_name=game_names.generator().get_test_name(name='old'),
                                                         description='old-description',
                                                         type=type,
                                                         max_health=max_health,
                                                         dedication=dedication,
