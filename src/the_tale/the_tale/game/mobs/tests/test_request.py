...
class PostMixin(object):
    def get_create_data(self, name='mob name'):
        word = game_names.generator().get_test_name(name=name)
        ...
        data.update({'level': 666,
                     ...
                     'features': [tt_beings_relations.FEATURE.FEATURE_1, tt_beings_relations.FEATURE.FEATURE_7],
                     'movement': tt_beings_relations.MOVEMENT.MOVEMENT_2,
                     'body': tt_beings_relations.BODY.BODY_3,
                     'size': tt_beings_relations.SIZE.SIZE_4,
    ...
    def get_update_data(self, name='new name'):
        ...
        data.update({'level': 667,
                     ...
                     'type': tt_beings_relations.TYPE.ANIMAL,
