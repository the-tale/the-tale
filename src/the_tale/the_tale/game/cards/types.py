...
class CARD(rels.Relation):
    ...
    records = (('LEVEL_UP', 1, 'озарение', FOR_ALL, LEGENDARY, effects.LevelUp(), []),
               ...
               ('ADD_POWER_COMMON', 78, 'новые обстоятельства', FOR_PREMIUMS, COMMON, effects.AddPoliticPower(base=c.CARD_BONUS_FOR_QUEST, level=1), [reactors.Simple3()]),
               ('ADD_POWER_UNCOMMON', 79, 'специальная операция', FOR_PREMIUMS, UNCOMMON, effects.AddPoliticPower(base=c.CARD_BONUS_FOR_QUEST, level=2), [reactors.Simple3()]),
               ('ADD_POWER_RARE', 80, 'слово Дабнглана', FOR_PREMIUMS, RARE, effects.AddPoliticPower(base=c.CARD_BONUS_FOR_QUEST, level=3), [reactors.Simple3()]),
               ('ADD_POWER_EPIC', 81, 'благословение Дабнглана', FOR_PREMIUMS, EPIC, effects.AddPoliticPower(base=c.CARD_BONUS_FOR_QUEST, level=4), [reactors.Simple3()]),
               ...
               ('ADD_POWER_LEGENDARY', 107, 'туз в рукаве', FOR_PREMIUMS, LEGENDARY, effects.AddPoliticPower(base=c.CARD_BONUS_FOR_QUEST, level=5), []),
