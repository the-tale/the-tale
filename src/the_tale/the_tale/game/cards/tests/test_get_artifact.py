...
class GetArtifactMixin(helpers.CardsTestMixin):
    ...
    def test_use_when_trading(self):
        ...
        action_trade = actions_prototypes.ActionTradingPrototype.create(hero=self.hero)
