...
class BattleContext(object):
    ...
    def __init__(self):
        ...
        self.pvp_advantage_strike_damage = power.Damage(0, 0)
        self.turn = 0
    ...
    def deserialize(cls, data):
        ...
        context.damage_queue_fire = [power.Damage.deserialize(damage) for damage in data.get('damage_queue_fire', [])]
        context.damage_queue_poison = [power.Damage.deserialize(damage) for damage in data.get('damage_queue_poison', [])]
        ...
        context.pvp_advantage_strike_damage = power.Damage.deserialize(data.get('pvp_advantage_strike_damage', (0, 0)))
