...
class ATTRIBUTE(game_attributes.ATTRIBUTE):
    records = (attributes.attr('SIZE', 0, 'размер города', default=lambda: 1, type=attributes.ATTRIBUTE_TYPE.CALCULATED,
               ...
               attributes.attr('RESET_RELIGION_CEREMONY_TIMEOUT_CHANCE', 19, 'обряд в честь Хранителя', verbose_units='%', formatter=attributes.percents_formatter,
                               description='Шанс начать обряд в честь Хранителя сразу после посещения города.'),
