...
class CITY_MODIFIERS(DjangoEnum):
    ...
    records = ( record('TRADE_CENTER', 0, 'Торговый центр', QUEST_PLACE_TYPE.NONE,
                ...
                record('FORT', 2, 'Форт', QUEST_PLACE_TYPE.NONE,
                       (('SAFETY', 0.05),),
                       'Постоянное присутствие военных делает окрестности города безопаснее для путешествий.'),

                record('POLITICAL_CENTER', 3, 'Политический центр', QUEST_PLACE_TYPE.NONE,
                ...
                record('POLIC', 4, 'Полис', QUEST_PLACE_TYPE.NONE,
                ...
                record('RESORT', 5, 'Курорт', QUEST_PLACE_TYPE.NONE,
                ...
                record('TRANSPORT_NODE', 6, 'Транспортный узел', QUEST_PLACE_TYPE.NONE,
                       (('TRANSPORT', 0.2),),
                ...
                record('OUTLAWS', 7, 'Вольница', QUEST_PLACE_TYPE.NONE,
                ...
                record('HOLY_CITY', 8, 'Святой город', QUEST_PLACE_TYPE.HOLY_CITY,
                ...
                record('NONE', 9, 'Обычный город', QUEST_PLACE_TYPE.NONE,
                       (),
