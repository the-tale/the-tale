...
class QUESTS(rels_django.DjangoEnum):
    ...
    records = (('SPYING', 0, 'шпионаж', questgen_quests_spying.Spying, QUEST_TYPE.NORMAL, 1.0),
               ('HUNT', 1, 'охота', questgen_quests_hunt.Hunt, QUEST_TYPE.CHARACTER, 1.0),
               ('HOMETOWN', 2, 'посетить родной город', questgen_quests_hometown.Hometown, QUEST_TYPE.CHARACTER, 1.0),
               ('SEARCH_SMITH', 3, 'посетить кузнеца', questgen_quests_search_smith.SearchSmith, QUEST_TYPE.NORMAL, 0.25),
               ('DELIVERY', 4, 'доставка', questgen_quests_delivery.Delivery, QUEST_TYPE.NORMAL, 1.0),
               ('CARAVAN', 5, 'караван', questgen_quests_caravan.Caravan, QUEST_TYPE.NORMAL, 1.0),
               ('COLLECT_DEBT', 6, 'возвращение долга', questgen_quests_collect_debt.CollectDebt, QUEST_TYPE.NORMAL, 1.0),
               ('HELP_FRIEND', 7, 'помощь соратнику', questgen_quests_help_friend.HelpFriend, QUEST_TYPE.CHARACTER, 1.0),
               ('INTERFERE_ENEMY', 8, 'вред противнику', questgen_quests_interfere_enemy.InterfereEnemy, QUEST_TYPE.CHARACTER, 1.0),
               ('HELP', 9, 'помощь', questgen_quests_help.Help, QUEST_TYPE.NORMAL, 1.0),
               ('PILGRIMAGE', 10, 'паломничество', questgen_quests_pilgrimage.Pilgrimage, QUEST_TYPE.UNIQUE, 0.1))
