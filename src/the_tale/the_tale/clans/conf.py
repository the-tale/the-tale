...
settings = utils_app_settings.app_settings('CLANS',
                                           CLANS_ON_PAGE=25,
                                           TT_CHRONICLE_ENTRY_POINT='http://tt-clans-chronicle:80/',
                                           TT_CLANS_PROPERTIES_ENTRY_POINT='http://tt-clans-properties:80/',
                                           TT_CLANS_POINTS_ENTRY_POINT='http://tt-clans-currencies:80/',
