...
class ClanForm(utils_forms.Form):
    ...
    description = bbcode_fields.BBField(label='Описание', max_length=models.Clan.MAX_DESCRIPTION_LENGTH)
...
class MembershipRequestForm(utils_forms.Form):
    text = bbcode_fields.BBField(label='Текст', max_length=models.MembershipRequest.MAX_TEXT_LENGTH)
