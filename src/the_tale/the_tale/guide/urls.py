...
urlpatterns += [django_urls.url(r'^mobs/', django_urls.include(old_views.resource_patterns(mobs_views.GuideMobResource), namespace='mobs')),
                django_urls.url(r'^artifacts/', django_urls.include(old_views.resource_patterns(artifacts_views.GuideArtifactResource), namespace='artifacts')),
