...
class DISCORD_ROLE(rels_django.DjangoEnum):
    ...
    records = (('DEVELOPER', 0, 'Разработчик', 'Разработчик игры.',
                'Может добавлять реакции на сообщения, загружать файлы, использовать эмодзи с других серверов, использовать команды @everyone и @here, смотреть логи сервера. Может управлять слышимостью Хранителей в голосовых каналах.'),
               ...
               ('MIGHTY_KEEPER', 3, 'Могучий Хранитель', 'Хранитель, имеющий 1000 могущества или более.',
                'Может добавлять реакции на сообщения, загружать файлы, использовать эмодзи с других серверов, использовать команды @everyone и @here, смотреть логи сервера.'),
               ...
               ('SPIRIT_OF_PANDORA', 5, 'Дух Пандоры', 'Хранитель, связавший аккаунт в игре с аккаунтом в Discord.',
                'Может добавлять реакции на сообщения, загружать файлы, смотреть логи сервера.'),
