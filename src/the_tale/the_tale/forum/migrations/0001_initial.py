    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(related_name='+', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
                ('subcategory', models.ForeignKey(to='forum.SubCategory', on_delete=models.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subcategory', models.ForeignKey(to='forum.SubCategory', null=True, on_delete=models.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(related_name='+', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
                ('thread', models.ForeignKey(to='forum.Thread', on_delete=models.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            ...
            name='thread',
            field=models.ForeignKey(to='forum.Thread', null=True, on_delete=models.CASCADE),
        ...
        migrations.AddField(
            ...
            name='subcategory',
            field=models.ForeignKey(to='forum.SubCategory', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
            name='permission',
