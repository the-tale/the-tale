...
urlpatterns = [django_urls.url(r'^registration/', django_urls.include(views.registration_resource.get_urls(), namespace='registration')),
               django_urls.url(r'^profile/', django_urls.include(views.profile_resource.get_urls(), namespace='profile')),
               django_urls.url(r'^auth/', django_urls.include(views.auth_resource.get_urls(), namespace='auth')),
