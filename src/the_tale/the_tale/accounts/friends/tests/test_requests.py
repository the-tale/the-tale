...
class FriendshipRequestsTests(utils_testcase.TestCase):
    ...
    def test_index__no_friends(self):
        self.check_html_ok(self.request_html(utils_urls.url('accounts:friends:')), texts=['pgf-no-friends-message'])
    ...
    def test_index(self):
        ...
        self.check_html_ok(self.request_html(utils_urls.url('accounts:friends:')), texts=[('pgf-no-friends-message', 0),
    ...
    def test_candidates__friends_only(self):
        prototypes.FriendshipPrototype.request_friendship(self.account_1, self.account_2, 'text 1')._confirm()
        prototypes.FriendshipPrototype.request_friendship(self.account_1, self.account_3, 'text 2')._confirm()
        self.check_html_ok(self.request_html(utils_urls.url('accounts:friends:candidates')), texts=[('pgf-no-candidates-message', 1),
    ...
    def test_candidates__no_candidates(self):
        self.check_html_ok(self.request_html(utils_urls.url('accounts:friends:candidates')), texts=['pgf-no-candidates-message'])
    ...
    def test_candidates(self):
        ...
        self.check_html_ok(self.request_html(utils_urls.url('accounts:friends:candidates')), texts=[('pgf-no-candidates-message', 0),
                                                                                                   (self.account_2.nick, 0),
                                                                                                   (self.account_3.nick, 1),
                                                                                                   (self.clan_2.abbr, 0),
                                                                                                   (self.clan_3.abbr, 1)])
    ...
    def test_friends__candidates_only(self):
        ...
        self.check_html_ok(self.request_html(utils_urls.url('accounts:friends:')), texts=[('pgf-no-friends-message', 1),
                                                                                         (self.account_2.nick, 0),
                                                                                         (self.account_3.nick, 0),
                                                                                         (self.clan_2.abbr, 0),
                                                                                         (self.clan_3.abbr, 0)])
    ...
    def test_request_friendship_form_error(self):
        self.check_ajax_error(self.client.post(utils_urls.url('accounts:friends:request', friend=self.account_2.id), {}),
    ...
    def test_remove_friendship(self):
        prototypes.FriendshipPrototype.request_friendship(self.account_1, self.account_2, 'text 1')._confirm()
        self.check_ajax_ok(self.client.post(utils_urls.url('accounts:friends:remove', friend=self.account_2.id)))
        self.assertEqual(models.Friendship.objects.all().count(), 0)
