...
class ProfileRequestsTests(TestCase, third_party_helpers.ThirdPartyTestsMixin):
    ...
    def test_profile_update_settings__personal_messages(self):
        ...
        response = self.client.post(reverse('accounts:profile:update-settings'), {'personal_messages_subscription': False, 'gender': game_relations.GENDER.FEMALE})
    ...
    def test_profile_update_settings__bews(self):
        ...
        response = self.client.post(reverse('accounts:profile:update-settings'), {'news_subscription': False, 'gender': game_relations.GENDER.FEMALE})
    ...
    def test_profile_update_settings__description(self):
        ...
        response = self.client.post(reverse('accounts:profile:update-settings'), {'description': 'new-description', 'gender': game_relations.GENDER.FEMALE})
    ...
    def test_profile_update_settings__gender(self):
        ...
        response = self.client.post(reverse('accounts:profile:update-settings'), {'gender': game_relations.GENDER.FEMALE})
        self.assertTrue(AccountPrototype.get_by_id(self.account.id).gender.is_FEMALE)
        self.check_ajax_ok(response, data={'next_url': reverse('accounts:profile:edited')})
