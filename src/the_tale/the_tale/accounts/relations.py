...
class MIGHT_AMOUNT(DjangoEnum):
    ...
    records = ( ('FOR_FORUM_POST', 0, u'за сообщение на форуме', 0.3, None),
                ...
                ('FOR_MIN_FOLCLOR_POST', 5, u'за фольклорное произведение', 20, None),
                ('FOR_ADDED_WORD_FOR_PLAYER', 6, u'за слово в лингвистике для игрока', 5, None),
                ('FOR_ADDED_WORD_FOR_MODERATOR', 7, u'за слово в лингвистике для модератора', 5, None),
                ('FOR_ADDED_TEMPLATE_FOR_PLAYER', 8, u'за фразу в лингвистике для игрока', 15, None),
                ('FOR_ADDED_TEMPLATE_FOR_MODERATOR', 9, u'за фразу в лингвистике для модератора', 15, None),
                ('AWARD_BUG_MINOR', 10, u'за небольшую ошибку', 111, AWARD_TYPE.BUG_MINOR),
                ('AWARD_BUG_NORMAL', 11, u'за среднюю ошибку', 222, AWARD_TYPE.BUG_NORMAL),
                ('AWARD_BUG_MAJOR', 12, u'за существенную ошибку', 333, AWARD_TYPE.BUG_MAJOR),
                ('AWARD_CONTEST_1_PLACE', 13, u'за 1-ое место в конкурсе', 1000, AWARD_TYPE.CONTEST_1_PLACE),
                ('AWARD_CONTEST_2_PLACE', 14, u'за 2-ое место в конкурсе', 666, AWARD_TYPE.CONTEST_2_PLACE),
                ('AWARD_CONTEST_3_PLACE', 15, u'за 3-е место в конкурсе', 333, AWARD_TYPE.CONTEST_3_PLACE),
                ('AWARD_STANDARD_MINOR', 16, u'обычная маленька награда', 333, AWARD_TYPE.STANDARD_MINOR),
                ('AWARD_STANDARD_NORMAL', 17, u'обычная средняя награда', 666, AWARD_TYPE.STANDARD_NORMAL),
                ('AWARD_STANDARD_MAJOR', 18, u'обычная большая награда', 1000, AWARD_TYPE.STANDARD_MAJOR) )
