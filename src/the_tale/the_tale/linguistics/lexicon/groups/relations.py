...
class LEXICON_GROUP(rels_django.DjangoEnum):
    ...
    records = (('ACTION_BATTLEPVE1X1', 0, 'Действие: сражение с монстром', 0,
               ...
               ('ACTION_MOVE_SIMPLE_TO', 6, 'Действие: путешествие в город', 60000,
                'Описание событий при путешествии героя в город',
                {V.DESTINATION: 'конечное место назначения', V.HERO: 'герой', V.HERO__WEAPON: 'оружие героя', V.CURRENT_DESTINATION: 'текущее место назначения', V.DATE: 'дата', V.TIME: 'время', V.CLAN: 'гильдия героя', V.CLAN_ABBR: 'аббревиатура гильдии героя', V.CLAN_MOTTO: 'девиз гильдии героя'}),
               ...
               ('ACTION_RELIGION', 8, 'Действие: проведение обряда в честь Хранителя', 80000,
                'Описание событий во время проведения героем религиозных обрядов в честь Хранителя героя.',
                {V.EXPERIENCE: 'количество опыта', V.HERO: 'герой', V.HERO__WEAPON: 'оружие героя', V.DATE: 'дата', V.TIME: 'время'}),
               ...
               ('JOBS', 31, 'Занятия Мастеров', 310000,
                ...
                {V.HERO: 'герой', V.HERO__WEAPON: 'оружие героя', V.PERSON: 'мастер', V.PLACE: 'город', V.COINS: 'монеты', V.ARTIFACT: 'артефакт', V.EXPERIENCE: 'опыт', V.DATE: 'дата', V.TIME: 'время'}),
