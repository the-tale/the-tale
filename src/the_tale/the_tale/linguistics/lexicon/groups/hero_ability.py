...
KEYS = [('HERO_ABILITY_FIREBALL', 280000, 'Журнал: Пиромания', LEXICON_GROUP.HERO_ABILITY,
        ...
        [V.ATTACKER, V.DAMAGE, V.DEFENDER], 'defender#N -damage#HP'),
        ...
        [V.HEALTH, V.ACTOR], 'actor#N +health#HP'),
        ...
        [V.ATTACKER, V.HEALTH, V.DAMAGE, V.DEFENDER], 'attacker#N +health#HP defender#N -damage#HP'),
        ...
        [V.ACTOR, V.COMPANION, V.HEALTH], 'companion#N +health#HP'),
        ...
        [V.ATTACKER, V.DEFENDER, V.DAMAGE, V.ATTACKER_DAMAGE], 'attacker#N -attacker_damage#HP defender#N -damage#HP'),
