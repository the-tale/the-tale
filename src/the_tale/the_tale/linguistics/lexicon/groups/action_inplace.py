...
KEYS = [('ACTION_INPLACE_DESCRIPTION', 80000, 'Описание', LEXICON_GROUP.ACTION_INPLACE,
        ...
        [V.DATE, V.COINS, V.HERO, V.ARTIFACT], None),
        ...
        [V.DATE, V.SELL_PRICE, V.HERO, V.OLD_ARTIFACT, V.COINS, V.ARTIFACT], 'hero#N -coins#G +sell_price#G'),
        ...
        [V.DATE, V.SELL_PRICE, V.COINS, V.HERO, V.ARTIFACT], 'hero#N -coins#G +sell_price#G'),
        ...
        [V.DATE, V.COINS, V.HERO, V.EXPERIENCE], 'hero#N -coins#G +experience#EXP'),
        ...
        [V.DATE, V.PERSON, V.COINS, V.HERO], 'hero#N -coins#G'),
        ...
        [V.DATE, V.COINS, V.HERO, V.HEALTH], 'hero#N +health#HP -coins#G'),
        ...
        [V.DATE, V.COINS, V.HERO, V.ARTIFACT], 'hero#N -coins#G'),
        ...
        [V.DATE, V.HERO, V.PLACE, V.ENERGY], 'hero#N +energy#EN'),
        ...
        [V.DATE, V.HERO, V.PLACE, V.COMPANION, V.HEALTH], 'companion#N +health#HP'),
        ...
        [V.DATE, V.HERO, V.PLACE, V.COMPANION], None),
        ...
        [V.DATE, V.HERO, V.PLACE, V.COMPANION, V.COINS, V.HEALTH], 'hero#N -coins#G companion#N +health#HP'),

        ('ACTION_INPLACE_ENTER', 80036, 'Герой входит в город', LEXICON_GROUP.ACTION_INPLACE,
