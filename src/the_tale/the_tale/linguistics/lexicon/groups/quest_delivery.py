...
KEYS = [('QUEST_DELIVERY_ACTION_DELIVERY_RETURNED', 400000, 'Активность: после убийства вора.', LEXICON_GROUP.QUEST_DELIVERY,
        ...
        [V.DATE, V.INITIATOR, V.HERO, V.ANTAGONIST_POSITION, V.INITIATOR_POSITION, V.RECEIVER, V.RECEIVER_POSITION, V.ANTAGONIST], None),
        ...
        [V.DATE, V.INITIATOR, V.HERO, V.ANTAGONIST_POSITION, V.ARTIFACT, V.INITIATOR_POSITION, V.RECEIVER, V.RECEIVER_POSITION, V.ANTAGONIST], None),
        ...
        [V.DATE, V.INITIATOR, V.HERO, V.ANTAGONIST_POSITION, V.COINS, V.INITIATOR_POSITION, V.RECEIVER, V.RECEIVER_POSITION, V.ANTAGONIST], 'hero#N +coins#G'),
