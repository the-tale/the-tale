...
KEYS = [('ANGEL_ABILITY_ARENA_PVP_1X1', 240000, 'Журнал: Отправка на PvP арену', LEXICON_GROUP.ANGEL_ABILITY,
        ...
        [V.DROPPED_ITEM, V.COINS, V.HERO], 'hero#N +coins#G'),

        ('ANGEL_ABILITY_EXPERIENCE', 240006, 'Журнал: Получение опыта', LEXICON_GROUP.ANGEL_ABILITY,
        'Получение опыта.',
        [V.HERO, V.EXPERIENCE], 'hero#N +experience#EXP'),
        ...
        [V.MOB, V.HERO, V.DAMAGE], 'mob#N -damage#HP'),
        ...
        [V.ENERGY, V.HERO], 'hero#N +energy#EN'),
        ...
        [V.HEALTH, V.HERO, V.COMPANION, V.HEALTH], 'companion#N +health#HP'),
