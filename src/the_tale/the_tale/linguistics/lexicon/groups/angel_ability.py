...
KEYS = [('ANGEL_ABILITY_ARENA_PVP_1X1', 240000, 'Журнал: Отправка на PvP арену', LEXICON_GROUP.ANGEL_ABILITY,
        ...
        [V.DATE, V.DROPPED_ITEM, V.COINS, V.HERO], 'hero#N +coins#G'),
        ...
        [V.DATE, V.MOB, V.HERO, V.DAMAGE], 'mob#N -damage#HP'),
        ...
        [V.DATE, V.ENERGY, V.HERO], 'hero#N +energy#EN'),
        ...
        [V.DATE, V.HEALTH, V.HERO, V.COMPANION, V.HEALTH], 'companion#N +health#HP'),
