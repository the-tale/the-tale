...
KEYS = [('COMPANIONS_RECEIVED', 580000, 'Дневник: появился спутник', LEXICON_GROUP.COMPANIONS,
        ...
        [V.COMPANION_OWNER, V.COMPANION, V.ATTACKER, V.DAMAGE], 'companion#N -damage#HP'),
        ...
        [V.COMPANION_OWNER, V.COMPANION, V.COINS], 'hero#N +coins#HP'),
        ...
        [V.COMPANION_OWNER, V.COMPANION, V.EXPERIENCE], 'companion_owner#N +experience#EXP'),
        ...
        [V.COMPANION_OWNER, V.COMPANION, V.HEALTH, V.MOB], 'companion#N +health#HP'),
        ...
        [V.COMPANION_OWNER, V.COMPANION, V.HEALTH], 'companion#N +health#HP'),
