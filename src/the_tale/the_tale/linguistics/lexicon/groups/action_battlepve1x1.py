...
KEYS = [(u'ACTION_BATTLEPVE1X1_ARTIFACT_BROKEN', 0, u'Дневник: Артефакт сломался во время боя', LEXICON_GROUP.ACTION_BATTLEPVE1X1,
        ...
        (u'ACTION_BATTLEPVE1X1_PERIODICAL_FIRE_DAMAGE', 11, u'Журнал: Периодический урон огнём', LEXICON_GROUP.ACTION_BATTLEPVE1X1,
         ...
         [V.DAMAGE, V.ACTOR], u'actor#N -damage#HP'),
        ...
        (u'ACTION_BATTLEPVE1X1_DIARY_HERO_AND_MOB_KILLED', 17, u'Дневник: Герой и враг убили друг друга', LEXICON_GROUP.ACTION_BATTLEPVE1X1,
         u'Герой и враг убили друг друга.',
         [V.MOB, V.HERO], None),

        (u'ACTION_BATTLEPVE1X1_JOURNAL_HERO_AND_MOB_KILLED', 18, u'Журнал: Герой и враг убили друг друга', LEXICON_GROUP.ACTION_BATTLEPVE1X1,
         u'Герой и враг убили друг друга.',
         [V.MOB, V.HERO], None),
