...
KEYS = [(u'QUEST_INTERFERE_ENEMY_ACTION_AFTER_INTERFERE', 500000, u'Активность: завершение', LEXICON_GROUP.QUEST_INTERFERE_ENEMY,
        ...
        [V.ANTAGONIST_POSITION, V.RECEIVER_POSITION, V.HERO, V.RECEIVER], None),
        ...
        [V.HERO, V.RECEIVER, V.ANTAGONIST_POSITION, V.RECEIVER_POSITION, V.ARTIFACT], None),
        ...
        [V.HERO, V.RECEIVER, V.ANTAGONIST_POSITION, V.RECEIVER_POSITION, V.COINS], u'hero#N +coins#G'),
