...
KEYS = [('QUEST_SPYING_ACTION_ARRIVED_TO_TARGET', 560000, 'Активность: герой приехал в город', LEXICON_GROUP.QUEST_SPYING,
        ...
        [V.DATE, V.INITIATOR, V.HERO, V.ARTIFACT, V.INITIATOR_POSITION, V.RECEIVER, V.RECEIVER_POSITION], None),
        ...
        'Герой получает награду за задание при самостоятельном шантаже (деньги).',
        [V.DATE, V.INITIATOR, V.HERO, V.COINS, V.INITIATOR_POSITION, V.RECEIVER, V.RECEIVER_POSITION], 'hero#N +coins#G'),
        ...
        [V.DATE, V.INITIATOR, V.HERO, V.INITIATOR_POSITION, V.RECEIVER, V.RECEIVER_POSITION], None),
