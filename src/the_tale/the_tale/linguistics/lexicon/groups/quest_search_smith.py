...
KEYS = [('QUEST_SEARCH_SMITH_ACTION_INTRO', 540000, 'Активность: интро', LEXICON_GROUP.QUEST_SEARCH_SMITH,
        ...
        [V.HERO, V.RECEIVER, V.RECEIVER_POSITION, V.COINS, V.ARTIFACT], 'hero#N -coins#G'),
        ...
        [V.UNEQUIPPED, V.HERO, V.COINS, V.ARTIFACT, V.SELL_PRICE, V.RECEIVER, V.RECEIVER_POSITION], 'hero#N -coins#G +sell_price#G'),
        ...
        [V.RECEIVER_POSITION, V.COINS, V.HERO, V.RECEIVER], 'hero#N -coins#G'),
        ...
        [V.UNEQUIPPED, V.SELL_PRICE, V.HERO, V.RECEIVER, V.RECEIVER_POSITION, V.ARTIFACT], None),
