...
KEYS = [('QUEST_CARAVAN_ACTION_ATTACK', 360000, 'Активность: нападение на охрану', LEXICON_GROUP.QUEST_CARAVAN,
        ...
        [V.DATE, V.INITIATOR, V.HERO, V.INITIATOR_POSITION, V.RECEIVER, V.ANTAGONIST_POSITION, V.RECEIVER_POSITION], None),
        ...
        [V.DATE, V.INITIATOR, V.HERO, V.INITIATOR_POSITION, V.RECEIVER, V.ANTAGONIST_POSITION, V.RECEIVER_POSITION, V.ARTIFACT], None),
        ...
        [V.DATE, V.INITIATOR, V.HERO, V.INITIATOR_POSITION, V.RECEIVER, V.ANTAGONIST_POSITION, V.RECEIVER_POSITION, V.COINS], 'hero#N +coins#G'),
