...
forms = [noun(['герой', 'героя', 'герою', 'героя', 'героем', 'герое',
         ...
         noun(['арбалет', 'арбалета', 'арбалету', 'арбалет', 'арбалетом', 'арбалете',
               'арбалеты', 'арбалетов', 'арбалетам', 'арбалеты', 'арбалетами', 'арбалетах'], 'но,мр'),
         noun(['облако', 'облака', 'облаку', 'облако', 'облаком', 'облаке',
               'облака', 'облаков', 'облакам', 'облака', 'облаками', 'облаках'], 'но,ср'),
         noun(['палица', 'палицы', 'палице', 'палицу', 'палицей', 'палице',
               'палицы', 'палиц', 'палицам', 'палицы', 'палицами', 'палицах'], 'но,жр'),
         noun(['', '', '', '', '', '',
               'нунчаки', 'нунчак', 'нунчакам', 'нунчаки', 'нунчаками', 'нунчаках'], 'но,мн'),
         ...
         deserialize({'forms': ['установить', 'установил', 'установило', 'установила', 'установили', '-', '-', '-', '-', '-', '-', 'установлю', 'установишь', 'установят', 'установим', 'установите', 'установят', 'установи', 'установим', 'установите'], 'properties': {7: 1, 15: 0}, 'type': 3}),
deserialize({'forms': ['смочь', 'смог', 'смогло', 'смогла', 'смогли', '-', '-', '-', '-', '-', '-', 'смогу', 'сможешь', 'смогут', 'сможем', 'сможете', 'смогут', 'смоги', 'сможем', 'смогите'], 'properties': {7: 1, 15: 0}, 'type': 3}),
        ]
