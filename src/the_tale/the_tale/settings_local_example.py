...
OWNER = '' # строка с ревизитами владельца сайта для пользовательского соглашения и футера сайта

PAGE_TITLE = '' # базовоый заголовок для страниц

SECRET_KEY = '!@#1231' # ваш УНИКАЛЬНЫЙ секретный ключ для некоторых частей фунциональности Django

GA_CODE = None # идентификатор в google analytics
ADDTHIS = None # идентификатор в addthis
MAIL_RU = None # номер счётчика mail.ru

SERVER_EMAIL = '' # почта сервера
ADMINS = () # перечень администраторов сайта (см. описание в конфигах Django)

EMAIL_NOREPLY = 'no-reply@example.com'  # почта, которая будет писаться в письмах, на которые игроки не должны отвечать
EMAIL_SUPPORT = '' # почта службы подержки
