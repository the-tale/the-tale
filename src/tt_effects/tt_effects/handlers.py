...
@handlers.protobuf_api(effects_pb2.RegisterRequest)
...
@handlers.protobuf_api(effects_pb2.RemoveRequest)
...
@handlers.protobuf_api(effects_pb2.UpdateRequest)
...
@handlers.protobuf_api(effects_pb2.ListRequest)
...
@handlers.protobuf_api(effects_pb2.DebugClearServiceRequest)
