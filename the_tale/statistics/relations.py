...
class RECORD_TYPE(DjangoEnum):
    ...
    records = ( ('TEST_INT', 0, u'тестовые данные (int)', VALUE_TYPE.INT, u'тестовые данные (int)'),
                ...
                ('ALIVE_AFTER_DAY', 14, u'конверсия 1-ого дня', VALUE_TYPE.INT, u'зарегистрировались в течении недели и были в игре через день'),
                ('ALIVE_AFTER_WEEK', 15, u'конверсия 1-ой недели', VALUE_TYPE.INT, u'зарегистрировались в течении недели и были в игре через неделю'),
                ('ALIVE_AFTER_MONTH', 16, u'конверсия 1-ого месяца', VALUE_TYPE.INT, u'зарегистрировались в течении недели и были в игре через месяц'),
                ('ALIVE_AFTER_3_MONTH', 17, u'конверсия 3-ого месяца', VALUE_TYPE.INT, u'зарегистрировались в течении недели и были в игре через 3 месяца'),
                ('ALIVE_AFTER_6_MONTH', 18, u'конверсия 6-ого месяца', VALUE_TYPE.INT, u'зарегистрировались в течении недели и были в игре через 6 месяцев'),
                ('ALIVE_AFTER_YEAR', 19, u'конверсия 1-ого года', VALUE_TYPE.INT, u'зарегистрировались в течении недели и были в игре через год'),
                ('ALIVE_AFTER_0', 20, u'всего регистраций', VALUE_TYPE.INT, u'зарегистрировались в течении недели'),
                ...
                ('INCOME_FROM_GOODS_PREFERENCE_RESET', 43, u'доход от сброса предпочтений', VALUE_TYPE.INT, u'доход от сброса предпочтений за день'),
                ...
                ('INCOME_GROUP_0_500_INCOME', 66, u'доходов от заплативших 0-500 печенек', VALUE_TYPE.INT, u'доходов от заплативших 0-500 печенек'),
                ('INCOME_GROUP_500_1000_INCOME', 67, u'доходов от заплативших 500-1000 печенек', VALUE_TYPE.INT, u'доходов от заплативших 500-1000 печенек'),
                ('INCOME_GROUP_1000_2500_INCOME', 68, u'доходов от заплативших 1000-2500 печенек', VALUE_TYPE.INT, u'доходов от заплативших 1000-2500 печенек'),
                ('INCOME_GROUP_2500_10000_INCOME', 69, u'доходов от заплативших 2500-10000 печенек', VALUE_TYPE.INT, u'доходов от заплативших 2500-10000 печенек'),
                ('INCOME_GROUP_10000_INCOME', 70, u'доходов от заплативших >10000 печенек', VALUE_TYPE.INT, u'доходов от заплативших >10000 печенек'),

                ('INCOME_GROUP_0_500_INCOME_PERCENTS', 71, u'% доходов от заплативших 0-500 печенек', VALUE_TYPE.FLOAT, u'% доходов от заплативших 0-500 печенек'),
                ('INCOME_GROUP_500_1000_INCOME_PERCENTS', 72, u'% доходов от заплативших 500-1000 печенек', VALUE_TYPE.FLOAT, u'% доходов от заплативших 500-1000 печенек'),
                ('INCOME_GROUP_1000_2500_INCOME_PERCENTS', 73, u'% доходов от заплативших 1000-2500 печенек', VALUE_TYPE.FLOAT, u'% доходов от заплативших 1000-2500 печенек'),
                ('INCOME_GROUP_2500_10000_INCOME_PERCENTS', 74, u'% доходов от заплативших 2500-10000 печенек', VALUE_TYPE.FLOAT, u'% доходов от заплативших 2500-10000 печенек'),
                ('INCOME_GROUP_10000_INCOME_PERCENTS', 75, u'% доходов от заплативших >10000 печенек', VALUE_TYPE.FLOAT, u'% доходов от заплативших >10000 печенек'),
