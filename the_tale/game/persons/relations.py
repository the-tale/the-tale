...
class PERSON_TYPE(DjangoEnum):
    ...
    records = ( ('BLACKSMITH',   0, u'кузнец', BUILDING_TYPE.SMITHY, questgen_relations.PROFESSION.BLACKSMITH),
                ...
                ('USURER',       16, u'ростовщик', BUILDING_TYPE.GUILDHALL, questgen_relations.PROFESSION.NONE),
                ('CLERK',        17, u'писарь', BUILDING_TYPE.BUREAU, questgen_relations.PROFESSION.NONE),
                ('MAGOMECHANIC', 18, u'магомеханик', BUILDING_TYPE.MANOR, questgen_relations.PROFESSION.NONE),
