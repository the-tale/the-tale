...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.out_game_at'
        db.add_column('persons_person', 'out_game_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2000, 1, 1, 0, 0)),
                      keep_default=False)

        if not db.dry_run:
            orm['persons.Person'].objects.all().update(out_game_at=datetime.datetime.now())

    def backwards(self, orm):
        # Deleting field 'Person.out_game_at'
        db.delete_column('persons_person', 'out_game_at')
