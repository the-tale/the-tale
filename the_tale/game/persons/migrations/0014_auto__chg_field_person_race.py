...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'persons_person', 'race', self.gf('rels.django_staff.TableIntegerField')())

    def backwards(self, orm):

        # Changing field 'Person.race'
        db.alter_column(u'persons_person', 'race', self.gf('django.db.models.fields.IntegerField')())
