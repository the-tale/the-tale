...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('persons_person', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2000, 1, 1, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'Person.created_at_turn'
        db.add_column('persons_person', 'created_at_turn',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Person.created_at_turn'
        db.delete_column('persons_person', 'created_at_turn')
    ...
    models = {
        ...
        'places.place': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifier': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '32', 'null': 'True'}),
