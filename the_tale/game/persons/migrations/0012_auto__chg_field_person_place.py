...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Person.place'
        db.alter_column(u'persons_person', 'place_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['places.Place']))

    def backwards(self, orm):

        # Changing field 'Person.place'
        db.alter_column(u'persons_person', 'place_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['places.Place']))
