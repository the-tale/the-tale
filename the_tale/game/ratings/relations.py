...
class RATING_TYPE(DjangoEnum):
    ...
    records = ( ('MIGHT', 'might', u'Могущество', u'', 'might'),
                ...
                ('GIFTS_RETURNED', 'gifts_returned', u'Возвращено подарков',
                 ...
                 'gifts_returned'),
                ('POLITICS_POWER', 'politics_power', u'Влиятельность', u'Влияние, которое герой оказывает своими заданиями (участвуют только герои, влияющие на всех Мастеров)', 'politics_power'),
              )
