...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RatingValues.pvp_battles_1x1_number'
        db.add_column('ratings_ratingvalues', 'pvp_battles_1x1_number',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'RatingValues.pvp_battles_1x1_victories'
        db.add_column('ratings_ratingvalues', 'pvp_battles_1x1_victories',
                      self.gf('django.db.models.fields.FloatField')(default=0.0, db_index=True),
                      keep_default=False)

        # Adding field 'RatingPlaces.pvp_battles_1x1_number_place'
        db.add_column('ratings_ratingplaces', 'pvp_battles_1x1_number_place',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'RatingPlaces.pvp_battles_1x1_wins_place'
        db.add_column('ratings_ratingplaces', 'pvp_battles_1x1_wins_place',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0, db_index=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'RatingValues.pvp_battles_1x1_number'
        db.delete_column('ratings_ratingvalues', 'pvp_battles_1x1_number')

        # Deleting field 'RatingValues.pvp_battles_1x1_victories'
        db.delete_column('ratings_ratingvalues', 'pvp_battles_1x1_victories')

        # Deleting field 'RatingPlaces.pvp_battles_1x1_number_place'
        db.delete_column('ratings_ratingplaces', 'pvp_battles_1x1_number_place')

        # Deleting field 'RatingPlaces.pvp_battles_1x1_wins_place'
        db.delete_column('ratings_ratingplaces', 'pvp_battles_1x1_wins_place')
    ...
    models = {
        ...
        'ratings.ratingplaces': {
            ...
            'pvp_battles_1x1_wins_place': ('django.db.models.fields.BigIntegerField', [], {'db_index': 'True'})
        },
