...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RatingPlaces.pvp_battles_1x1_victories_place'
        db.add_column('ratings_ratingplaces', 'pvp_battles_1x1_victories_place',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0, db_index=True),
                      keep_default=False)

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'RatingPlaces.pvp_battles_1x1_wins_place'
        raise RuntimeError("Cannot reverse this migration. 'RatingPlaces.pvp_battles_1x1_wins_place' and its values cannot be restored.")
        # Deleting field 'RatingPlaces.pvp_battles_1x1_victories_place'
        db.delete_column('ratings_ratingplaces', 'pvp_battles_1x1_victories_place')
