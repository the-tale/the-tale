...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RatingValues.power'
        db.delete_column(u'ratings_ratingvalues', 'power')

        # Adding field 'RatingValues.magic_power'
        db.add_column(u'ratings_ratingvalues', 'magic_power',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'RatingValues.physic_power'
        db.add_column(u'ratings_ratingvalues', 'physic_power',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Deleting field 'RatingPlaces.power_place'
        db.delete_column(u'ratings_ratingplaces', 'power_place')

        # Adding field 'RatingPlaces.magic_power_place'
        db.add_column(u'ratings_ratingplaces', 'magic_power_place',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'RatingPlaces.physic_power_place'
        db.add_column(u'ratings_ratingplaces', 'physic_power_place',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'RatingValues.power'
        db.add_column(u'ratings_ratingvalues', 'power',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Deleting field 'RatingValues.magic_power'
        db.delete_column(u'ratings_ratingvalues', 'magic_power')

        # Deleting field 'RatingValues.physic_power'
        db.delete_column(u'ratings_ratingvalues', 'physic_power')


        # User chose to not deal with backwards NULL issues for 'RatingPlaces.power_place'
        raise RuntimeError("Cannot reverse this migration. 'RatingPlaces.power_place' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'RatingPlaces.power_place'
        db.add_column(u'ratings_ratingplaces', 'power_place',
                      self.gf('django.db.models.fields.BigIntegerField')(db_index=True),
                      keep_default=False)

        # Deleting field 'RatingPlaces.magic_power_place'
        db.delete_column(u'ratings_ratingplaces', 'magic_power_place')

        # Deleting field 'RatingPlaces.physic_power_place'
        db.delete_column(u'ratings_ratingplaces', 'physic_power_place')
    ...
    models = {
        ...
        u'ratings.ratingplaces': {
            ...
            'achievements_points_place': ('django.db.models.fields.IntegerField', [], {'default': '0', 'db_index': 'True'}),
            'bills_count_place': ('django.db.models.fields.BigIntegerField', [], {'db_index': 'True'}),
            'help_count_place': ('django.db.models.fields.IntegerField', [], {'default': '0', 'db_index': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'level_place': ('django.db.models.fields.BigIntegerField', [], {'db_index': 'True'}),
            'magic_power_place': ('django.db.models.fields.BigIntegerField', [], {'db_index': 'True'}),
            ...
            'physic_power_place': ('django.db.models.fields.BigIntegerField', [], {'db_index': 'True'}),
        ...
        u'ratings.ratingvalues': {
            ...
            'account': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.Account']"}),
            'achievements_points': ('django.db.models.fields.IntegerField', [], {'default': '0', 'db_index': 'True'}),
            'bills_count': ('django.db.models.fields.IntegerField', [], {'default': '0', 'db_index': 'True'}),
            'help_count': ('django.db.models.fields.IntegerField', [], {'default': '0', 'db_index': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'level': ('django.db.models.fields.IntegerField', [], {'default': '0', 'db_index': 'True'}),
            'magic_power': ('django.db.models.fields.IntegerField', [], {'default': '0', 'db_index': 'True'}),
            ...
            'physic_power': ('django.db.models.fields.IntegerField', [], {'default': '0', 'db_index': 'True'}),
