...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RatingValues.gifts_returned'
        db.add_column(u'ratings_ratingvalues', 'gifts_returned',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'RatingPlaces.gifts_returned_place'
        db.add_column(u'ratings_ratingplaces', 'gifts_returned_place',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RatingValues.gifts_returned'
        db.delete_column(u'ratings_ratingvalues', 'gifts_returned')

        # Deleting field 'RatingPlaces.gifts_returned_place'
        db.delete_column(u'ratings_ratingplaces', 'gifts_returned_place')
    ...
    models = {
        ...
        u'ratings.ratingplaces': {
            ...
            'gifts_returned_place': ('django.db.models.fields.IntegerField', [], {'default': '0', 'db_index': 'True'}),
        ...
        u'ratings.ratingvalues': {
            ...
            'gifts_returned': ('django.db.models.fields.IntegerField', [], {'default': '0', 'db_index': 'True'}),
