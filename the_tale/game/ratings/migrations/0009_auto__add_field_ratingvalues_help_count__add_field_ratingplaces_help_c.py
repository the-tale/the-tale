...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RatingValues.help_count'
        db.add_column(u'ratings_ratingvalues', 'help_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'RatingPlaces.help_count_place'
        db.add_column(u'ratings_ratingplaces', 'help_count_place',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RatingValues.help_count'
        db.delete_column(u'ratings_ratingvalues', 'help_count')

        # Deleting field 'RatingPlaces.help_count_place'
        db.delete_column(u'ratings_ratingplaces', 'help_count_place')
