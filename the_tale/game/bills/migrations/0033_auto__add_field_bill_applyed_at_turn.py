...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bill.applyed_at_turn'
        db.add_column(u'bills_bill', 'applyed_at_turn',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bill.applyed_at_turn'
        db.delete_column(u'bills_bill', 'applyed_at_turn')
    ...
    models = {
        ...
        u'bills.bill': {
            ...
            'applyed_at_turn': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
