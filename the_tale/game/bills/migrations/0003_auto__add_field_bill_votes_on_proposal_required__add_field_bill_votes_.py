...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bill.votes_on_proposal_required'
        db.add_column('bills_bill', 'votes_on_proposal_required',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Bill.votes_fraction_on_voting_required'
        db.add_column('bills_bill', 'votes_fraction_on_voting_required',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Bill.votes_on_proposal_required'
        db.delete_column('bills_bill', 'votes_on_proposal_required')

        # Deleting field 'Bill.votes_fraction_on_voting_required'
        db.delete_column('bills_bill', 'votes_fraction_on_voting_required')
    ...
    models = {
        ...
        'bills.bill': {
            ...
            'forum_proposal_thread': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['forum.Thread']"}),
            'forum_voting_thread': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['forum.Thread']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'votes_fraction_on_voting_required': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'votes_on_proposal_required': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        'bills.vote': {
