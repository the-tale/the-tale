...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('bills_bill', 'state', self.gf('rels.django_staff.TableIntegerField')())

        # Changing field 'Bill.type'
        db.alter_column('bills_bill', 'type', self.gf('rels.django_staff.TableIntegerField')())
