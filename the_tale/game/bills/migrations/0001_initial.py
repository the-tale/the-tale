...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bills_bill', (
            ...
            ('forum_proposal_thread', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['forum.Thread'])),
            ('forum_voting_thread', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['forum.Thread'])),
    ...
    models = {
        ...
        'bills.bill': {
            ...
            'forum_voting_thread': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['forum.Thread']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
