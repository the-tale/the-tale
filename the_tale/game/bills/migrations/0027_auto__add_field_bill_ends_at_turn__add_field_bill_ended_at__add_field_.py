...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bill.ends_at_turn'
        db.add_column(u'bills_bill', 'ends_at_turn',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Bill.ended_at'
        db.add_column(u'bills_bill', 'ended_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Bill.duration'
        db.add_column(u'bills_bill', 'duration',
                      self.gf('rels.django_staff.TableIntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Bill.ends_at_turn'
        db.delete_column(u'bills_bill', 'ends_at_turn')

        # Deleting field 'Bill.ended_at'
        db.delete_column(u'bills_bill', 'ended_at')

        # Deleting field 'Bill.duration'
        db.delete_column(u'bills_bill', 'duration')
    ...
    models = {
        ...
        u'bills.bill': {
            ...
            'declined_by': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'+'", 'null': 'True', 'to': u"orm['bills.Bill']"}),
            'duration': ('rels.django_staff.TableIntegerField', [], {}),
            'ended_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'ends_at_turn': ('django.db.models.fields.BigIntegerField', [], {'null': 'True', 'db_index': 'True'}),
