...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Bill.step_started_at'
        db.delete_column('bills_bill', 'step_started_at')

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Bill.step_started_at'
        raise RuntimeError("Cannot reverse this migration. 'Bill.step_started_at' and its values cannot be restored.")
    models = {
        'auth.group': {
