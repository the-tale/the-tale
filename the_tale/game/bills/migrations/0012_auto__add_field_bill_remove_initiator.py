...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bill.remove_initiator'
        db.add_column('bills_bill', 'remove_initiator',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['accounts.Account']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Bill.remove_initiator'
        db.delete_column('bills_bill', 'remove_initiator_id')
