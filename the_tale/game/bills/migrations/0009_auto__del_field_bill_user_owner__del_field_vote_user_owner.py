...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Bill.user_owner'
        db.delete_column('bills_bill', 'user_owner_id')

        # Deleting field 'Vote.user_owner'
        db.delete_column('bills_vote', 'user_owner_id')

    def backwards(self, orm):
        # Adding field 'Bill.user_owner'
        db.add_column('bills_bill', 'user_owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Vote.user_owner'
        db.add_column('bills_vote', 'user_owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['auth.User']),
                      keep_default=False)
    ...
    models = {
        ...
        'bills.bill': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['accounts.Account']"}),
