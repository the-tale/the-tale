...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Bill.min_votes_required'
        db.delete_column(u'bills_bill', 'min_votes_required')

        # Adding field 'Bill.voting_end_at'
        db.add_column(u'bills_bill', 'voting_end_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Bill.min_votes_required'
        db.add_column(u'bills_bill', 'min_votes_required',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Bill.voting_end_at'
        db.delete_column(u'bills_bill', 'voting_end_at')
