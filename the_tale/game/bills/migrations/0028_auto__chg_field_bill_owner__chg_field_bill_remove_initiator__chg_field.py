...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'bills_bill', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['accounts.Account']))

        # Changing field 'Bill.remove_initiator'
        db.alter_column(u'bills_bill', 'remove_initiator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['accounts.Account']))

        # Changing field 'Bill.declined_by'
        db.alter_column(u'bills_bill', 'declined_by_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['bills.Bill'], null=True))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Bill.owner'
        raise RuntimeError("Cannot reverse this migration. 'Bill.owner' and its values cannot be restored.")

        # Changing field 'Bill.remove_initiator'
        db.alter_column(u'bills_bill', 'remove_initiator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.Account']))

        # Changing field 'Bill.declined_by'
        db.alter_column(u'bills_bill', 'declined_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['bills.Bill']))
    models = {
        u'accounts.account': {
