...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for bill in orm['bills.Bill'].objects.all():
            bill.owner = orm['accounts.Account'].objects.get(user=bill.user_owner)
            bill.save()

        for vote in orm['bills.Vote'].objects.all():
            vote.owner = orm['accounts.Account'].objects.get(user=vote.user_owner)
            vote.save()
