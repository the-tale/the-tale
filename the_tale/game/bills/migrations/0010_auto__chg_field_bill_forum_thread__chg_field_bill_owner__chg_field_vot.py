...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bill.forum_thread'
        db.alter_column('bills_bill', 'forum_thread_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['forum.Thread']))

        # Changing field 'Bill.owner'
        db.alter_column('bills_bill', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['accounts.Account']))

        # Changing field 'Vote.owner'
        db.alter_column('bills_vote', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['accounts.Account']))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Bill.forum_thread'
        raise RuntimeError("Cannot reverse this migration. 'Bill.forum_thread' and its values cannot be restored.")

        # Changing field 'Bill.owner'
        db.alter_column('bills_bill', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.Account']))

        # Changing field 'Vote.owner'
        db.alter_column('bills_vote', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.Account']))
    models = {
        'accounts.account': {
        ...
        'bills.bill': {
            ...
            'forum_thread': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['forum.Thread']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.Account']"}),
