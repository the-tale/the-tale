...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Bill.reject_reason'
        db.delete_column(u'bills_bill', 'reject_reason')

        # Adding field 'Bill.chronicle_on_accepted'
        db.add_column(u'bills_bill', 'chronicle_on_accepted',
                      self.gf('django.db.models.fields.TextField')(default=u'', blank=True),
                      keep_default=False)

        # Adding field 'Bill.chronicle_on_ended'
        db.add_column(u'bills_bill', 'chronicle_on_ended',
                      self.gf('django.db.models.fields.TextField')(default=u'', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Bill.reject_reason'
        db.add_column(u'bills_bill', 'reject_reason',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'Bill.chronicle_on_accepted'
        db.delete_column(u'bills_bill', 'chronicle_on_accepted')

        # Deleting field 'Bill.chronicle_on_ended'
        db.delete_column(u'bills_bill', 'chronicle_on_ended')
