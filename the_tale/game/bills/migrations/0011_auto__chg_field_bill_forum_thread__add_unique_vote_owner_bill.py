...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('bills_bill', 'forum_thread_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['forum.Thread']))
        # Adding unique constraint on 'Vote', fields ['owner', 'bill']
        db.create_unique('bills_vote', ['owner_id', 'bill_id'])

    def backwards(self, orm):
        # Removing unique constraint on 'Vote', fields ['owner', 'bill']
        db.delete_unique('bills_vote', ['owner_id', 'bill_id'])
