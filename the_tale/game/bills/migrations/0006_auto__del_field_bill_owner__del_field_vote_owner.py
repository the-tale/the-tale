...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Bill.owner'
        db.delete_column('bills_bill', 'owner_id')

        # Deleting field 'Vote.owner'
        db.delete_column('bills_vote', 'owner_id')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Vote.owner'
        raise RuntimeError("Cannot reverse this migration. 'Vote.owner' and its values cannot be restored.")
    models = {
        'auth.group': {
        ...
        'bills.bill': {
            ...
            'user_owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['auth.User']"}),
