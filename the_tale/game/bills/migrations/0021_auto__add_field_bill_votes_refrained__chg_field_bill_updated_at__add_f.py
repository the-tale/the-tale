...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bill.votes_refrained'
        db.add_column(u'bills_bill', 'votes_refrained',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


        # Changing field 'Bill.updated_at'
        db.alter_column(u'bills_bill', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
        # Adding field 'Vote.type'
        db.add_column(u'bills_vote', 'type',
                      self.gf('rels.django_staff.TableIntegerField')(default=0, db_index=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Bill.votes_refrained'
        db.delete_column(u'bills_bill', 'votes_refrained')


        # Changing field 'Bill.updated_at'
        db.alter_column(u'bills_bill', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
        # Deleting field 'Vote.type'
        db.delete_column(u'bills_vote', 'type')
