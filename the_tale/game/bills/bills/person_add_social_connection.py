...
class PersonAddSocialConnection(BaseBill):
    ...
    def get_moderator_form_update(self, post=None, initial=None, owner_id=None):
        if initial:
            return self.ModeratorForm(self.person_id, owner_id, initial=initial) #pylint: disable=E1102
        return  self.ModeratorForm(self.person_id, owner_id, post) #pylint: disable=E1102
