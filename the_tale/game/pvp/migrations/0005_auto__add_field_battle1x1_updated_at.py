...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Battle1x1.updated_at'
        db.add_column(u'pvp_battle1x1', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 3, 27, 0, 0), blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Battle1x1.updated_at'
        db.delete_column(u'pvp_battle1x1', 'updated_at')
    ...
    models = {
        ...
        u'pvp.battle1x1': {
            ...
            'enemy': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': u"orm['accounts.Account']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'result': ('django.db.models.fields.IntegerField', [], {'default': '0', 'db_index': 'True'}),
