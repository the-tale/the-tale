...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Battle1x1.calculate_rating'
        db.add_column('pvp_battle1x1', 'calculate_rating',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)

        # Adding field 'Battle1x1.result'
        db.add_column('pvp_battle1x1', 'result',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding index on 'Battle1x1', fields ['state']
        db.create_index('pvp_battle1x1', ['state'])

    def backwards(self, orm):
        # Removing index on 'Battle1x1', fields ['state']
        db.delete_index('pvp_battle1x1', ['state'])

        # Deleting field 'Battle1x1.calculate_rating'
        db.delete_column('pvp_battle1x1', 'calculate_rating')

        # Deleting field 'Battle1x1.result'
        db.delete_column('pvp_battle1x1', 'result')
