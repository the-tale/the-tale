...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Battle1x1'
        db.create_table('pvp_battle1x1', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', unique=True, to=orm['accounts.Account'])),
            ('enemy', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', unique=True, null=True, to=orm['accounts.Account'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('state', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal('pvp', ['Battle1x1'])

    def backwards(self, orm):
        # Deleting model 'Battle1x1'
        db.delete_table('pvp_battle1x1')
    ...
    models = {
        ...
        'pvp.battle1x1': {
            ...
            'enemy': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'unique': 'True', 'null': 'True', 'to': "orm['accounts.Account']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
