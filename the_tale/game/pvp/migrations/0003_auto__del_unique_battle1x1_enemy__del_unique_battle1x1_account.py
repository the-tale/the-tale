...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('pvp_battle1x1', ['account_id'])

        # Removing unique constraint on 'Battle1x1', fields ['enemy']
        db.delete_unique('pvp_battle1x1', ['enemy_id'])

    def backwards(self, orm):
        # Adding unique constraint on 'Battle1x1', fields ['enemy']
        db.create_unique('pvp_battle1x1', ['enemy_id'])

        # Adding unique constraint on 'Battle1x1', fields ['account']
        db.create_unique('pvp_battle1x1', ['account_id'])
    ...
    models = {
        ...
        'pvp.battle1x1': {
            ...
            'enemy': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['accounts.Account']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
