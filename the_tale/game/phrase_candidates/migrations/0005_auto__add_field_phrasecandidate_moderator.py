...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PhraseCandidate.moderator'
        db.add_column('phrase_candidates_phrasecandidate', 'moderator',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='+', to=orm['accounts.Account']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'PhraseCandidate.moderator'
        db.delete_column('phrase_candidates_phrasecandidate', 'moderator_id')
    ...
    models = {
        ...
        'phrase_candidates.phrasecandidate': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'moderator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['accounts.Account']"}),
