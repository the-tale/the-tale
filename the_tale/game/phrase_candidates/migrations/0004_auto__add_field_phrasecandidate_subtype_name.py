...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PhraseCandidate.subtype_name'
        db.add_column('phrase_candidates_phrasecandidate', 'subtype_name',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=256),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'PhraseCandidate.subtype_name'
        db.delete_column('phrase_candidates_phrasecandidate', 'subtype_name')
    ...
    models = {
        ...
        'phrase_candidates.phrasecandidate': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.Account']"}),
