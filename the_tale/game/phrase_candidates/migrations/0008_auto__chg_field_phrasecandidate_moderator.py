...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PhraseCandidate.moderator'
        db.alter_column(u'phrase_candidates_phrasecandidate', 'moderator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['accounts.Account']))

    def backwards(self, orm):

        # Changing field 'PhraseCandidate.moderator'
        db.alter_column(u'phrase_candidates_phrasecandidate', 'moderator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.Account']))
