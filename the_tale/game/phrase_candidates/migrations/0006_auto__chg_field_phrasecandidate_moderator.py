...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('phrase_candidates_phrasecandidate', 'moderator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.Account']))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PhraseCandidate.moderator'
        raise RuntimeError("Cannot reverse this migration. 'PhraseCandidate.moderator' and its values cannot be restored.")
    models = {
        'accounts.account': {
