...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PhraseCandidate.subtype'
        db.add_column('phrase_candidates_phrasecandidate', 'subtype',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=256),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'PhraseCandidate.subtype'
        db.delete_column('phrase_candidates_phrasecandidate', 'subtype')
