...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('phrase_candidates_phrasecandidate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Account'])),
        ...
        db.send_create_signal('phrase_candidates', ['PhraseCandidate'])

    def backwards(self, orm):
        # Deleting model 'PhraseCandidate'
        db.delete_table('phrase_candidates_phrasecandidate')
