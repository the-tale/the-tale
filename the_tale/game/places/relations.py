...
class ATTRIBUTE(attributes.ATTRIBUTE):
    records = ( attributes.attr('SIZE', 0, u'размер города', default=lambda: 1, type=attributes.ATTRIBUTE_TYPE.CALCULATED,
                ...
                attributes.attr('SAFETY', 7, u'безопасность', verbose_units=u'%',
                ...
                attributes.attr('STABILITY_RENEWING_SPEED', 12, u'восстанволение стабильности', order=-1, verbose_units=u'%',
                 description=u'Скорость восстановления стабильности в городе.'),
                attributes.attr('EXPERIENCE_BONUS', 13, u'бонус к опыту', verbose_units=u'%',
                 description=u'Бонус к количеству опыта за задания, связанные с этим городом.'),
                attributes.attr('BUY_PRICE', 14, u'цена попупки предметов', verbose_units=u'%',
                 description=u'Цена покупки артефактов.'),
                attributes.attr('SELL_PRICE', 15, u'цена продажи предметов', verbose_units=u'%',
                ...
                attributes.attr('ENERGY_REGEN_CHANCE', 19, u'восстановление энергии', verbose_units=u'%',
                 description=u'Шанс восстановить энергию при входе в город.'),
                attributes.attr('HERO_REGEN_CHANCE', 20, u'лечение героя', verbose_units=u'%',
                 description=u'Шанс героя полностью вылечиться при входе в город.'),
                attributes.attr('COMPANION_REGEN_CHANCE', 21, u'лечение спутника', verbose_units=u'%',
                ...
                attributes.attr('MODIFIER_TRADE_CENTER', 23, u'специализация «Торговый центр»', verbose_units=u'%',
                 description=u'Соответствие города специализации «Торговый центр».'),
                attributes.attr('MODIFIER_CRAFT_CENTER', 24, u'специализация «Город мастеров»', verbose_units=u'%',
                 description=u'Соответствие города специализации «Город мастеров».'),
                attributes.attr('MODIFIER_FORT', 25, u'специализация «Форт»', verbose_units=u'%',
                 description=u'Соответствие города специализации «Форт».'),
                attributes.attr('MODIFIER_POLITICAL_CENTER', 26, u'специализация «Политический центр»', verbose_units=u'%',
                 description=u'Соответствие города специализации «Политический центр».'),
                attributes.attr('MODIFIER_POLIC', 27, u'специализация «Полис»', verbose_units=u'%',
                 description=u'Соответствие города специализации «Полис».'),
                attributes.attr('MODIFIER_RESORT', 28, u'специализация «Курорт»', verbose_units=u'%',
                 description=u'Соответствие города специализации «Курорт».'),
                attributes.attr('MODIFIER_TRANSPORT_NODE', 29, u'специализация «Транспортный узел»', verbose_units=u'%',
                 description=u'Соответствие города специализации «Транспортный узел».'),
                attributes.attr('MODIFIER_OUTLAWS', 30, u'специализация «Вольница»', verbose_units=u'%',
                 description=u'Соответствие города специализации «Вольница».'),
                attributes.attr('MODIFIER_HOLY_CITY', 31, u'специализация «Святой город»', verbose_units=u'%',
