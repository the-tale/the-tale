...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('places_heroposition', (
            ...
            ('place', self.gf('django.db.models.fields.related.ForeignKey')(related_name='positions', to=orm['places.Place'])),
    ...
    models = {
        ...
        'places.heroposition': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'place': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'positions'", 'to': "orm['places.Place']"})
        },
        'places.place': {
