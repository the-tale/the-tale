...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ResourceExchange'
        db.create_table(u'places_resourceexchange', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('place_1', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['places.Place'])),
            ('place_2', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['places.Place'])),
            ('resource_1', self.gf('rels.django_staff.TableIntegerField')()),
            ('resource_2', self.gf('rels.django_staff.TableIntegerField')()),
            ('bill', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['bills.Bill'])),
        ))
        db.send_create_signal(u'places', ['ResourceExchange'])

    def backwards(self, orm):
        # Deleting model 'ResourceExchange'
        db.delete_table(u'places_resourceexchange')
    ...
    models = {
        ...
        u'places.resourceexchange': {
            ...
            'bill': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': u"orm['bills.Bill']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
