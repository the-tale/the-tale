...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Place.modifier'
        db.alter_column(u'places_place', 'modifier', self.gf('rels.django.RelationIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Place.modifier'
        db.alter_column(u'places_place', 'modifier', self.gf('django.db.models.fields.IntegerField')(null=True))
