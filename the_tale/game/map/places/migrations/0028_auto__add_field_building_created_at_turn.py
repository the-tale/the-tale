...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Building.created_at_turn'
        db.add_column(u'places_building', 'created_at_turn',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Building.created_at_turn'
        db.delete_column(u'places_building', 'created_at_turn')
