...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Place.habit_honor_positive'
        db.add_column(u'places_place', 'habit_honor_positive',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Place.habit_honor_negative'
        db.add_column(u'places_place', 'habit_honor_negative',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Place.habit_peacefulness_positive'
        db.add_column(u'places_place', 'habit_peacefulness_positive',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Place.habit_peacefulness_negative'
        db.add_column(u'places_place', 'habit_peacefulness_negative',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Place.habit_honor'
        db.add_column(u'places_place', 'habit_honor',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Place.habit_peacefulness'
        db.add_column(u'places_place', 'habit_peacefulness',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Place.habit_honor_positive'
        db.delete_column(u'places_place', 'habit_honor_positive')

        # Deleting field 'Place.habit_honor_negative'
        db.delete_column(u'places_place', 'habit_honor_negative')

        # Deleting field 'Place.habit_peacefulness_positive'
        db.delete_column(u'places_place', 'habit_peacefulness_positive')

        # Deleting field 'Place.habit_peacefulness_negative'
        db.delete_column(u'places_place', 'habit_peacefulness_negative')

        # Deleting field 'Place.habit_honor'
        db.delete_column(u'places_place', 'habit_honor')

        # Deleting field 'Place.habit_peacefulness'
        db.delete_column(u'places_place', 'habit_peacefulness')
