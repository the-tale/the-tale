...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Place.updated_at_turn'
        db.add_column('places_place', 'updated_at_turn',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Place.updated_at_turn'
        db.delete_column('places_place', 'updated_at_turn')
