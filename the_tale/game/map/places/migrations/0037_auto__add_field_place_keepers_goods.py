...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Place.keepers_goods'
        db.add_column(u'places_place', 'keepers_goods',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Place.keepers_goods'
        db.delete_column(u'places_place', 'keepers_goods')
