...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'places_place', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'Place.created_at_turn'
        db.add_column(u'places_place', 'created_at_turn',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'places_place', 'created_at')

        # Deleting field 'Place.created_at_turn'
        db.delete_column(u'places_place', 'created_at_turn')
