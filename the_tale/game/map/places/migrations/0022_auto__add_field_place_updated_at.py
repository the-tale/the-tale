...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Place.updated_at'
        db.add_column(u'places_place', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 6, 26, 0, 0), blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Place.updated_at'
        db.delete_column(u'places_place', 'updated_at')
