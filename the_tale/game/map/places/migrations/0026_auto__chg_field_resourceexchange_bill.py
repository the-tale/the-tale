...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ResourceExchange.bill'
        db.alter_column(u'places_resourceexchange', 'bill_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['bills.Bill']))

    def backwards(self, orm):

        # Changing field 'ResourceExchange.bill'
        db.alter_column(u'places_resourceexchange', 'bill_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['bills.Bill']))
