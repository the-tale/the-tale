...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('roads_waymark', 'road_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['roads.Road']))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Waymark.road'
        raise RuntimeError("Cannot reverse this migration. 'Waymark.road' and its values cannot be restored.")
