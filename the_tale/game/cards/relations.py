...
class CARD_TYPE(DjangoEnum):
    ...
    records = ( ('LEVEL_UP', 1, u'озарение', AVAILABILITY.FOR_ALL, RARITY.LEGENDARY, forms.EmptyForm,),
                ...
                ('ADD_POWER_LEGENDARY', 107, u'туз в рукаве', AVAILABILITY.FOR_PREMIUMS, RARITY.LEGENDARY, forms.EmptyForm,),
                ('PERSON_POWER_BONUS_POSITIVE_COMMON', 108, u'улыбка фортуны', AVAILABILITY.FOR_PREMIUMS, RARITY.COMMON, forms.PersonForm),

                ('PLACE_POWER_BONUS_POSITIVE_COMMON', 109, u'выгодный контракт', AVAILABILITY.FOR_PREMIUMS, RARITY.COMMON, forms.PlaceForm),
                ('PLACE_POWER_BONUS_NEGATIVE_COMMON', 110, u'сорванный контракт', AVAILABILITY.FOR_PREMIUMS, RARITY.COMMON, forms.PlaceForm),
                )
