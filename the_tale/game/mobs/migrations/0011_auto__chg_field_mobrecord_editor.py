...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MobRecord.editor'
        db.alter_column(u'mobs_mobrecord', 'editor_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['accounts.Account']))

    def backwards(self, orm):

        # Changing field 'MobRecord.editor'
        db.alter_column(u'mobs_mobrecord', 'editor_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.Account']))
