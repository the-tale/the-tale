...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'MobRecord', fields ['state']
        db.create_index(u'mobs_mobrecord', ['state'])

        # Adding index on 'MobRecord', fields ['type']
        db.create_index(u'mobs_mobrecord', ['type'])


    def backwards(self, orm):
        # Removing index on 'MobRecord', fields ['type']
        db.delete_index(u'mobs_mobrecord', ['type'])

        # Removing index on 'MobRecord', fields ['state']
        db.delete_index(u'mobs_mobrecord', ['state'])
