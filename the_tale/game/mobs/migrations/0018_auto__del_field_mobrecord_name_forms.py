...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MobRecord.name_forms'
        db.delete_column(u'mobs_mobrecord', 'name_forms')


    def backwards(self, orm):
        # Adding field 'MobRecord.name_forms'
        db.add_column(u'mobs_mobrecord', 'name_forms',
