...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'mobs_mobrecord', 'type',
                      self.gf('rels.django.RelationIntegerField')(default=5),
                      keep_default=False)


        # Changing field 'MobRecord.state'
        db.alter_column(u'mobs_mobrecord', 'state', self.gf('rels.django.RelationIntegerField')())

    def backwards(self, orm):
        # Deleting field 'MobRecord.type'
        db.delete_column(u'mobs_mobrecord', 'type')


        # Changing field 'MobRecord.state'
        db.alter_column(u'mobs_mobrecord', 'state', self.gf('django.db.models.fields.IntegerField')())
