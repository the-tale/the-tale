...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MobRecord'
        db.create_table('mobs_mobrecord', (
            ...
            ('abilities', self.gf('django.db.models.fields.TextField')()),
            ('terrains', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('mobs', ['MobRecord'])

    def backwards(self, orm):
        # Deleting model 'MobRecord'
        db.delete_table('mobs_mobrecord')
