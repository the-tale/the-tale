...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MobConstructor.terrain'
        db.add_column('mobs_mobconstructor', 'terrain', self.gf('django.db.models.fields.CharField')(default='.', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MobConstructor.terrain'
        db.delete_column('mobs_mobconstructor', 'terrain')
