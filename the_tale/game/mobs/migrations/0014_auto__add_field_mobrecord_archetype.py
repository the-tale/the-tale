...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MobRecord.archetype'
        db.add_column(u'mobs_mobrecord', 'archetype',
                      self.gf('rels.django.RelationIntegerField')(default=1, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MobRecord.archetype'
        db.delete_column(u'mobs_mobrecord', 'archetype')
