...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Angel.updated_at_turn'
        db.add_column('angels_angel', 'updated_at_turn',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Angel.updated_at_turn'
        db.delete_column('angels_angel', 'updated_at_turn')
