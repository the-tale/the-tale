...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Angel.might_updated_time'
        db.delete_column('angels_angel', 'might_updated_time')

        # Deleting field 'Angel.might'
        db.delete_column('angels_angel', 'might')

    def backwards(self, orm):
        # Adding field 'Angel.might_updated_time'
        db.add_column('angels_angel', 'might_updated_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2000, 1, 1, 0, 0), auto_now_add=True, blank=True, db_index=True),
                      keep_default=False)

        # Adding field 'Angel.might'
        db.add_column('angels_angel', 'might',
