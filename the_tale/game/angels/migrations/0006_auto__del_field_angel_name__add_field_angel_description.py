...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Angel.name'
        db.delete_column('angels_angel', 'name')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Angel.name'
        raise RuntimeError("Cannot reverse this migration. 'Angel.name' and its values cannot be restored.")
