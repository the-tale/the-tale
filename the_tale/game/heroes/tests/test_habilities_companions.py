...
class HabilitiesCompanionsTest(testcase.TestCase):
    ...
    def test_healing(self):
        self.assertEqual(companions.HEALING().modify_attribute(MODIFIERS.COMPANION_LIVING_HEAL, 0), 0.002314814814814815)
        ...
        self.assertEqual(self.hero.companion_living_heal_probability, 0.006944444444444445)

    def test_mage_mechanincs(self):
        self.assertEqual(companions.MAGE_MECHANICS().modify_attribute(MODIFIERS.COMPANION_CONSTRUCT_HEAL, 0), 0.002314814814814815)
        ...
        self.assertEqual(self.hero.companion_construct_heal_probability, 0.006944444444444445)

    def test_witchcraft(self):
        self.assertEqual(companions.WITCHCRAFT().modify_attribute(MODIFIERS.COMPANION_UNUSUAL_HEAL, 0), 0.002314814814814815)
        ...
        self.assertEqual(self.hero.companion_unusual_heal_probability, 0.006944444444444445)
