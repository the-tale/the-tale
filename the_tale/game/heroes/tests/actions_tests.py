...
from game.heroes.actions import Action, ActionsContainer
...
class ActionTests(testcase.TestCase):
    ...
    def setUp(self):
        ...
        self.action = Action(percents=0.6, description=u'bla-bla', info_link=u'/info')
    ...
    def test_serialization(self):
        self.assertEqual(self.action.serialize(), Action.deserialize(self.action.serialize()).serialize())
...
class ActionsContainerTests(testcase.TestCase):
    ...
    def setUp(self):
        ...
        self.action_1 = Action(percents=0.1, description=u'bla-1', info_link=u'/info-1')
        self.action_2 = Action(percents=0.2, description=u'bla-2', info_link=u'/info-2')
        self.action_3 = Action(percents=0.3, description=u'bla-3', info_link=u'/info-3')
    ...
    def test_push_action(self):
        ...
        action_4 = Action(percents=0.4, description=u'bla-4', info_link=u'/info-4')
