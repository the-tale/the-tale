...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Hero.context'
        db.add_column('heroes_hero', 'context', self.gf('django.db.models.fields.TextField')(default='{}'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Hero.context'
        db.delete_column('heroes_hero', 'context')
