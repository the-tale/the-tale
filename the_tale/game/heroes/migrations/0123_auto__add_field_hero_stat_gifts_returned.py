...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hero.stat_gifts_returned'
        db.add_column(u'heroes_hero', 'stat_gifts_returned',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Hero.stat_gifts_returned'
        db.delete_column(u'heroes_hero', 'stat_gifts_returned')
