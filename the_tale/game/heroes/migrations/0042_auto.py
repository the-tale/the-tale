...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Hero', fields ['active_state_end_at']
        db.create_index('heroes_hero', ['active_state_end_at'])

    def backwards(self, orm):
        # Removing index on 'Hero', fields ['active_state_end_at']
        db.delete_index('heroes_hero', ['active_state_end_at'])
