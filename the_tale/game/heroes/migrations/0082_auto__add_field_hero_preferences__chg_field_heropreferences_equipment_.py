...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hero.preferences'
        db.add_column(u'heroes_hero', 'preferences',
                      self.gf('django.db.models.fields.TextField')(default='{}'),
                      keep_default=False)


        # Changing field 'HeroPreferences.equipment_slot'
        db.alter_column(u'heroes_heropreferences', 'equipment_slot', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Hero.preferences'
        db.delete_column(u'heroes_hero', 'preferences')


        # Changing field 'HeroPreferences.equipment_slot'
        db.alter_column(u'heroes_heropreferences', 'equipment_slot', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))
