...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hero.cards_help_count'
        db.add_column(u'heroes_hero', 'cards_help_count',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Hero.cards_help_count'
        db.delete_column(u'heroes_hero', 'cards_help_count')
