...
LEVELS = {  'mob': 8,
            ...
            'friend': 12,
            'enemy': 20,
            'energy_regeneration_type': 1,
            'equipment_slot': 36,
            'risk_level': 32,
            'favorite_item': 28,
            'archetype': 16,
            'companion_dedication': 24,
            'companion_empathy': 40 }
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for hero in orm['heroes.Hero'].objects.all().iterator():
            ...
            for preference_id, preference_level in LEVELS.iteritems():
                if hero.level < preference_level and preference_id in preferences:
                    del preferences[preference_id]
