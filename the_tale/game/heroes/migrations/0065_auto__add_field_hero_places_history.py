...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hero.places_history'
        db.add_column(u'heroes_hero', 'places_history',
                      self.gf('django.db.models.fields.TextField')(default='{}'),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Hero.places_history'
        db.delete_column(u'heroes_hero', 'places_history')
