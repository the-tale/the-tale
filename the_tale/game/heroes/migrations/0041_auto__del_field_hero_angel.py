...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Hero.angel'
        db.delete_column('heroes_hero', 'angel_id')

    def backwards(self, orm):
        # Adding field 'Hero.angel'
        db.add_column('heroes_hero', 'angel',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='heroes', null=True, to=orm['angels.Angel'], blank=True),
                      keep_default=False)
