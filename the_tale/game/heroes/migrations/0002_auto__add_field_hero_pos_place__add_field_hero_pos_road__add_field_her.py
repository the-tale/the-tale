...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Hero.pos_place'
        db.add_column('heroes_hero', 'pos_place', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', null=True, blank=True, to=orm['places.Place']), keep_default=False)

        # Adding field 'Hero.pos_road'
        db.add_column('heroes_hero', 'pos_road', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', null=True, blank=True, to=orm['roads.Road']), keep_default=False)

        # Adding field 'Hero.pos_percents'
        db.add_column('heroes_hero', 'pos_percents', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'Hero.pos_invert_direction'
        db.add_column('heroes_hero', 'pos_invert_direction', self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Hero.pos_place'
        db.delete_column('heroes_hero', 'pos_place_id')

        # Deleting field 'Hero.pos_road'
        db.delete_column('heroes_hero', 'pos_road_id')

        # Deleting field 'Hero.pos_percents'
        db.delete_column('heroes_hero', 'pos_percents')

        # Deleting field 'Hero.pos_invert_direction'
        db.delete_column('heroes_hero', 'pos_invert_direction')
