...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hero.stat_money_spend_for_companions'
        db.add_column(u'heroes_hero', 'stat_money_spend_for_companions',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Hero.stat_money_spend_for_companions'
        db.delete_column(u'heroes_hero', 'stat_money_spend_for_companions')
