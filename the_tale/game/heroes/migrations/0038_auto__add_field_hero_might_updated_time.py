...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hero.might_updated_time'
        db.add_column('heroes_hero', 'might_updated_time',
    ...
    def backwards(self, orm):
        # Deleting field 'Hero.might_updated_time'
        db.delete_column('heroes_hero', 'might_updated_time')
