...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Hero.stat_pvp_battles_number'
        db.delete_column('heroes_hero', 'stat_pvp_battles_number')

        # Deleting field 'Hero.stat_pvp_battles_draws'
        db.delete_column('heroes_hero', 'stat_pvp_battles_draws')

        # Deleting field 'Hero.stat_pvp_battles_victories'
        db.delete_column('heroes_hero', 'stat_pvp_battles_victories')

        # Adding field 'Hero.stat_pvp_battles_1x1_number'
        db.add_column('heroes_hero', 'stat_pvp_battles_1x1_number',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Hero.stat_pvp_battles_1x1_victories'
        db.add_column('heroes_hero', 'stat_pvp_battles_1x1_victories',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Hero.stat_pvp_battles_1x1_draws'
        db.add_column('heroes_hero', 'stat_pvp_battles_1x1_draws',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Hero.stat_pvp_battles_number'
        db.add_column('heroes_hero', 'stat_pvp_battles_number',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Hero.stat_pvp_battles_draws'
        db.add_column('heroes_hero', 'stat_pvp_battles_draws',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Hero.stat_pvp_battles_victories'
        db.add_column('heroes_hero', 'stat_pvp_battles_victories',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Hero.stat_pvp_battles_1x1_number'
        db.delete_column('heroes_hero', 'stat_pvp_battles_1x1_number')

        # Deleting field 'Hero.stat_pvp_battles_1x1_victories'
        db.delete_column('heroes_hero', 'stat_pvp_battles_1x1_victories')

        # Deleting field 'Hero.stat_pvp_battles_1x1_draws'
        db.delete_column('heroes_hero', 'stat_pvp_battles_1x1_draws')
