...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Hero.habit_peacefulness'
        db.add_column(u'heroes_hero', 'habit_peacefulness',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Hero.habit_peacefulness'
        db.delete_column(u'heroes_hero', 'habit_peacefulness')
