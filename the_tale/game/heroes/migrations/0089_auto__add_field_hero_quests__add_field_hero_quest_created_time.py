...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hero.quests'
        db.add_column(u'heroes_hero', 'quests',
                      self.gf('django.db.models.fields.TextField')(default='{}'),
                      keep_default=False)

        # Adding field 'Hero.quest_created_time'
        db.add_column(u'heroes_hero', 'quest_created_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0), db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Hero.quests'
        db.delete_column(u'heroes_hero', 'quests')

        # Deleting field 'Hero.quest_created_time'
        db.delete_column(u'heroes_hero', 'quest_created_time')
