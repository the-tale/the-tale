...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for hero_model in orm['heroes.Hero'].objects.all():
            orm['heroes.HeroPreferences'].objects.create(hero=hero_model,
                                                         energy_regeneration_type=hero_model.pref_energy_regeneration_type,
                                                         mob=hero_model.pref_mob,
                                                         place=hero_model.pref_place,
                                                         friend=hero_model.pref_friend,
                                                         enemy=hero_model.pref_enemy,
                                                         equipment_slot=int(hero_model.pref_equipment_slot) if hero_model.pref_equipment_slot is not None else None)
    ...
    models = {
        ...
        u'heroes.heropreferences': {
            ...
            'equipment_slot': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '16', 'null': 'True', 'blank': 'True'}),
