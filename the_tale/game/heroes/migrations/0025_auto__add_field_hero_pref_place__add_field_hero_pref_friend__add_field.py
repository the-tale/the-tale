...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('heroes_hero', 'pref_place',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', null=True, to=orm['places.Place']),
                      keep_default=False)

        # Adding field 'Hero.pref_friend'
        db.add_column('heroes_hero', 'pref_friend',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', null=True, to=orm['persons.Person']),
                      keep_default=False)

        # Adding field 'Hero.pref_enemy'
        db.add_column('heroes_hero', 'pref_enemy',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', null=True, to=orm['persons.Person']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Hero.pref_place'
        db.delete_column('heroes_hero', 'pref_place_id')

        # Deleting field 'Hero.pref_friend'
        db.delete_column('heroes_hero', 'pref_friend_id')

        # Deleting field 'Hero.pref_enemy'
        db.delete_column('heroes_hero', 'pref_enemy_id')
    ...
    models = {
        ...
        'heroes.choosepreferencestask': {
            ...
            'hero': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['heroes.Hero']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'preference_id': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '32'}),
