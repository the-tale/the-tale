...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Hero.destiny_points'
        db.add_column('heroes_hero', 'destiny_points', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'Hero.abilities'
        db.add_column('heroes_hero', 'abilities', self.gf('django.db.models.fields.TextField')(default='{}'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Hero.destiny_points'
        db.delete_column('heroes_hero', 'destiny_points')

        # Deleting field 'Hero.abilities'
        db.delete_column('heroes_hero', 'abilities')
