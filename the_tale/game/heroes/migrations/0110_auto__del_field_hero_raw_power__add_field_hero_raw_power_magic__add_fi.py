...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Hero.raw_power'
        db.delete_column(u'heroes_hero', 'raw_power')

        # Adding field 'Hero.raw_power_magic'
        db.add_column(u'heroes_hero', 'raw_power_magic',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Hero.raw_power_physic'
        db.add_column(u'heroes_hero', 'raw_power_physic',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Hero.stat_money_spend_for_repairing'
        db.add_column(u'heroes_hero', 'stat_money_spend_for_repairing',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'HeroPreferences.archetype'
        db.add_column(u'heroes_heropreferences', 'archetype',
                      self.gf('rels.django.RelationIntegerField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Hero.raw_power'
        db.add_column(u'heroes_hero', 'raw_power',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Hero.raw_power_magic'
        db.delete_column(u'heroes_hero', 'raw_power_magic')

        # Deleting field 'Hero.raw_power_physic'
        db.delete_column(u'heroes_hero', 'raw_power_physic')

        # Deleting field 'Hero.stat_money_spend_for_repairing'
        db.delete_column(u'heroes_hero', 'stat_money_spend_for_repairing')

        # Deleting field 'HeroPreferences.archetype'
        db.delete_column(u'heroes_heropreferences', 'archetype')
