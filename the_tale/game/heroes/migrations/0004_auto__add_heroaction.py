...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'HeroAction'
        db.create_table('heroes_heroaction', (
        ...
        db.send_create_signal('heroes', ['HeroAction'])

        # Removing M2M table for field actions on 'Hero'
        db.delete_table('heroes_hero_actions')


    def backwards(self, orm):
        
        # Deleting model 'HeroAction'
        db.delete_table('heroes_heroaction')

        # Adding M2M table for field actions on 'Hero'
        db.create_table('heroes_hero_actions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('hero', models.ForeignKey(orm['heroes.hero'], null=False)),
            ('action', models.ForeignKey(orm['actions.action'], null=False))
        ))
        db.create_unique('heroes_hero_actions', ['hero_id', 'action_id'])
