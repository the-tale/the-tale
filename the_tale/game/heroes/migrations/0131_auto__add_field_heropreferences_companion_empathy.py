...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HeroPreferences.companion_empathy'
        db.add_column(u'heroes_heropreferences', 'companion_empathy',
                      self.gf('rels.django.RelationIntegerField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HeroPreferences.companion_empathy'
        db.delete_column(u'heroes_heropreferences', 'companion_empathy')
