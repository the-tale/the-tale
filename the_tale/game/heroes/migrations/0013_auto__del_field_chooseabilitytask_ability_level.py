...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ChooseAbilityTask.ability_level'
        db.delete_column('heroes_chooseabilitytask', 'ability_level')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'ChooseAbilityTask.ability_level'
        raise RuntimeError("Cannot reverse this migration. 'ChooseAbilityTask.ability_level' and its values cannot be restored.")
