...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hero.last_rare_operation_at_turn'
        db.add_column(u'heroes_hero', 'last_rare_operation_at_turn',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Hero.last_rare_operation_at_turn'
        db.delete_column(u'heroes_hero', 'last_rare_operation_at_turn')
