...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing index on 'Hero', fields ['pref_friend_changed_at']
        db.delete_index('heroes_hero', ['pref_friend_changed_at'])

        # Removing index on 'Hero', fields ['pref_place_changed_at']
        db.delete_index('heroes_hero', ['pref_place_changed_at'])

        # Removing index on 'Hero', fields ['pref_mob_changed_at']
        db.delete_index('heroes_hero', ['pref_mob_changed_at'])

        # Removing index on 'Hero', fields ['pref_enemy_changed_at']
        db.delete_index('heroes_hero', ['pref_enemy_changed_at'])

    def backwards(self, orm):
        # Adding index on 'Hero', fields ['pref_enemy_changed_at']
        db.create_index('heroes_hero', ['pref_enemy_changed_at'])

        # Adding index on 'Hero', fields ['pref_mob_changed_at']
        db.create_index('heroes_hero', ['pref_mob_changed_at'])

        # Adding index on 'Hero', fields ['pref_place_changed_at']
        db.create_index('heroes_hero', ['pref_place_changed_at'])

        # Adding index on 'Hero', fields ['pref_friend_changed_at']
        db.create_index('heroes_hero', ['pref_friend_changed_at'])
    ...
    models = {
        ...
        'heroes.hero': {
            ...
            'pref_energy_regeneration_type': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
