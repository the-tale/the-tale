...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Hero.experience'
        db.alter_column(u'heroes_hero', 'experience', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Hero.experience'
        db.alter_column(u'heroes_hero', 'experience', self.gf('django.db.models.fields.FloatField')())
    ...
    models = {
        ...
        u'heroes.hero': {
            ...
            'race': ('rels.django_staff.TableIntegerField', [], {}),
