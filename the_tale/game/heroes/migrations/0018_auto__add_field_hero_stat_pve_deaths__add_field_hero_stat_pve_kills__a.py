...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hero.stat_pve_deaths'
        db.add_column('heroes_hero', 'stat_pve_deaths',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Hero.stat_pve_kills'
        db.add_column('heroes_hero', 'stat_pve_kills',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Hero.stat_money_earned_from_loot'
        db.add_column('heroes_hero', 'stat_money_earned_from_loot',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Hero.stat_money_earned_from_artifacts'
        db.add_column('heroes_hero', 'stat_money_earned_from_artifacts',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Hero.stat_money_earned_from_quests'
        db.add_column('heroes_hero', 'stat_money_earned_from_quests',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Hero.stat_money_spend_for_heal'
        db.add_column('heroes_hero', 'stat_money_spend_for_heal',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Hero.stat_money_spend_for_artifacts'
        db.add_column('heroes_hero', 'stat_money_spend_for_artifacts',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Hero.stat_money_spend_for_sharpening'
        db.add_column('heroes_hero', 'stat_money_spend_for_sharpening',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Hero.stat_money_spend_for_useless'
        db.add_column('heroes_hero', 'stat_money_spend_for_useless',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Hero.stat_money_spend_for_impact'
        db.add_column('heroes_hero', 'stat_money_spend_for_impact',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Hero.stat_artifacts_had'
        db.add_column('heroes_hero', 'stat_artifacts_had',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Hero.stat_loot_had'
        db.add_column('heroes_hero', 'stat_loot_had',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Hero.stat_quests_done'
        db.add_column('heroes_hero', 'stat_quests_done',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Hero.stat_pve_deaths'
        db.delete_column('heroes_hero', 'stat_pve_deaths')

        # Deleting field 'Hero.stat_pve_kills'
        db.delete_column('heroes_hero', 'stat_pve_kills')

        # Deleting field 'Hero.stat_money_earned_from_loot'
        db.delete_column('heroes_hero', 'stat_money_earned_from_loot')

        # Deleting field 'Hero.stat_money_earned_from_artifacts'
        db.delete_column('heroes_hero', 'stat_money_earned_from_artifacts')

        # Deleting field 'Hero.stat_money_earned_from_quests'
        db.delete_column('heroes_hero', 'stat_money_earned_from_quests')

        # Deleting field 'Hero.stat_money_spend_for_heal'
        db.delete_column('heroes_hero', 'stat_money_spend_for_heal')

        # Deleting field 'Hero.stat_money_spend_for_artifacts'
        db.delete_column('heroes_hero', 'stat_money_spend_for_artifacts')

        # Deleting field 'Hero.stat_money_spend_for_sharpening'
        db.delete_column('heroes_hero', 'stat_money_spend_for_sharpening')

        # Deleting field 'Hero.stat_money_spend_for_useless'
        db.delete_column('heroes_hero', 'stat_money_spend_for_useless')

        # Deleting field 'Hero.stat_money_spend_for_impact'
        db.delete_column('heroes_hero', 'stat_money_spend_for_impact')

        # Deleting field 'Hero.stat_artifacts_had'
        db.delete_column('heroes_hero', 'stat_artifacts_had')

        # Deleting field 'Hero.stat_loot_had'
        db.delete_column('heroes_hero', 'stat_loot_had')

        # Deleting field 'Hero.stat_quests_done'
        db.delete_column('heroes_hero', 'stat_quests_done')
