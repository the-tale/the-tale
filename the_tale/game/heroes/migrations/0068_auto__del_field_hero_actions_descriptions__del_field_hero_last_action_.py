...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Hero.actions_descriptions'
        db.delete_column(u'heroes_hero', 'actions_descriptions')

        # Deleting field 'Hero.last_action_percents'
        db.delete_column(u'heroes_hero', 'last_action_percents')

    def backwards(self, orm):
        # Adding field 'Hero.actions_descriptions'
        db.add_column(u'heroes_hero', 'actions_descriptions',
                      self.gf('django.db.models.fields.TextField')(default='[]'),
                      keep_default=False)

        # Adding field 'Hero.last_action_percents'
        db.add_column(u'heroes_hero', 'last_action_percents',
