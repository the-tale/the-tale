...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Hero.destiny_points_spend'
        db.add_column('heroes_hero', 'destiny_points_spend', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Hero.destiny_points_spend'
        db.delete_column('heroes_hero', 'destiny_points_spend')
