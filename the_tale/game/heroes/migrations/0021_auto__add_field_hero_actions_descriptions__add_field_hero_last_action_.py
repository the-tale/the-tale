...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('heroes_hero', 'actions_descriptions',
                      self.gf('django.db.models.fields.TextField')(default='[]'),
                      keep_default=False)

        # Adding field 'Hero.last_action_percents'
        db.add_column('heroes_hero', 'last_action_percents',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Hero.actions_descriptions'
        db.delete_column('heroes_hero', 'actions_descriptions')

        # Deleting field 'Hero.last_action_percents'
        db.delete_column('heroes_hero', 'last_action_percents')
