...
def convert(data):
    data['messages'] = [message + [u''] for message in data['messages']]
    return data
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for hero in orm['heroes.Hero'].objects.all():
            hero.messages = json.dumps(convert(json.loads(hero.messages)))
            hero.diary = json.dumps(convert(json.loads(hero.diary)))
            hero.save()
