...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Hero.active_state_end_at'
        db.delete_column(u'heroes_hero', 'active_state_end_at')

        # Adding field 'Hero.change_person_power_allowed_end_at'
        db.add_column(u'heroes_hero', 'change_person_power_allowed_end_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0), db_index=True),
                      keep_default=False)

        # Adding field 'Hero.normal_experience_rate_end_at'
        db.add_column(u'heroes_hero', 'normal_experience_rate_end_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0), db_index=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Hero.active_state_end_at'
        db.add_column(u'heroes_hero', 'active_state_end_at',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Deleting field 'Hero.change_person_power_allowed_end_at'
        db.delete_column(u'heroes_hero', 'change_person_power_allowed_end_at')

        # Deleting field 'Hero.normal_experience_rate_end_at'
        db.delete_column(u'heroes_hero', 'normal_experience_rate_end_at')
    ...
    models = {
        ...
        u'heroes.hero': {
            ...
            'change_person_power_allowed_end_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(1970, 1, 1, 0, 0)', 'db_index': 'True'}),
            ...
            'normal_experience_rate_end_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(1970, 1, 1, 0, 0)', 'db_index': 'True'}),
