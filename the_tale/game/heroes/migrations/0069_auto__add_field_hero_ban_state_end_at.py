...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hero.ban_state_end_at'
        db.add_column(u'heroes_hero', 'ban_state_end_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0), db_index=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Hero.ban_state_end_at'
        db.delete_column(u'heroes_hero', 'ban_state_end_at')
