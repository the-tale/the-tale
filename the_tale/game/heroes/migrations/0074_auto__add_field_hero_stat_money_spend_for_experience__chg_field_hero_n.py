...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hero.stat_money_spend_for_experience'
        db.add_column(u'heroes_hero', 'stat_money_spend_for_experience',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)


        # Changing field 'Hero.next_spending'
        db.alter_column(u'heroes_hero', 'next_spending', self.gf('rels.django.RelationIntegerField')())
    def backwards(self, orm):
        ...
        # Changing field 'Hero.next_spending'
        db.alter_column(u'heroes_hero', 'next_spending', self.gf('django.db.models.fields.IntegerField')())
    models = {
        u'accounts.account': {
