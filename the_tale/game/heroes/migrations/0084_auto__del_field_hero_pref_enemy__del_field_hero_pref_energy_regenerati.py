...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Hero.pref_enemy'
        db.delete_column(u'heroes_hero', 'pref_enemy_id')

        # Deleting field 'Hero.pref_energy_regeneration_type'
        db.delete_column(u'heroes_hero', 'pref_energy_regeneration_type')

        # Deleting field 'Hero.pref_energy_regeneration_type_changed_at'
        db.delete_column(u'heroes_hero', 'pref_energy_regeneration_type_changed_at')

        # Deleting field 'Hero.pref_place_changed_at'
        db.delete_column(u'heroes_hero', 'pref_place_changed_at')

        # Deleting field 'Hero.pref_equipment_slot_changed_at'
        db.delete_column(u'heroes_hero', 'pref_equipment_slot_changed_at')

        # Deleting field 'Hero.pref_mob'
        db.delete_column(u'heroes_hero', 'pref_mob_id')

        # Deleting field 'Hero.pref_friend_changed_at'
        db.delete_column(u'heroes_hero', 'pref_friend_changed_at')

        # Deleting field 'Hero.pref_mob_changed_at'
        db.delete_column(u'heroes_hero', 'pref_mob_changed_at')

        # Deleting field 'Hero.pref_friend'
        db.delete_column(u'heroes_hero', 'pref_friend_id')

        # Deleting field 'Hero.pref_enemy_changed_at'
        db.delete_column(u'heroes_hero', 'pref_enemy_changed_at')

        # Deleting field 'Hero.pref_equipment_slot'
        db.delete_column(u'heroes_hero', 'pref_equipment_slot')

        # Deleting field 'Hero.pref_place'
        db.delete_column(u'heroes_hero', 'pref_place_id')


    def backwards(self, orm):
        # Adding field 'Hero.pref_enemy'
        db.add_column(u'heroes_hero', 'pref_enemy',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', on_delete=models.PROTECT, default=None, to=orm['persons.Person'], blank=True, null=True),
                      keep_default=False)

        # Adding field 'Hero.pref_energy_regeneration_type'
        db.add_column(u'heroes_hero', 'pref_energy_regeneration_type',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'Hero.pref_energy_regeneration_type_changed_at'
        db.add_column(u'heroes_hero', 'pref_energy_regeneration_type_changed_at',
        ...
        db.add_column(u'heroes_hero', 'pref_place_changed_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2000, 1, 1, 0, 0)),
                      keep_default=False)

        # Adding field 'Hero.pref_equipment_slot_changed_at'
        db.add_column(u'heroes_hero', 'pref_equipment_slot_changed_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2000, 1, 1, 0, 0)),
                      keep_default=False)

        # Adding field 'Hero.pref_mob'
        db.add_column(u'heroes_hero', 'pref_mob',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['mobs.MobRecord'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)

        # Adding field 'Hero.pref_friend_changed_at'
        db.add_column(u'heroes_hero', 'pref_friend_changed_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2000, 1, 1, 0, 0)),
                      keep_default=False)

        # Adding field 'Hero.pref_mob_changed_at'
        db.add_column(u'heroes_hero', 'pref_mob_changed_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2000, 1, 1, 0, 0)),
                      keep_default=False)

        # Adding field 'Hero.pref_friend'
        db.add_column(u'heroes_hero', 'pref_friend',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', on_delete=models.PROTECT, default=None, to=orm['persons.Person'], blank=True, null=True),
                      keep_default=False)

        # Adding field 'Hero.pref_enemy_changed_at'
        db.add_column(u'heroes_hero', 'pref_enemy_changed_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2000, 1, 1, 0, 0)),
                      keep_default=False)

        # Adding field 'Hero.pref_equipment_slot'
        db.add_column(u'heroes_hero', 'pref_equipment_slot',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Hero.pref_place'
        db.add_column(u'heroes_hero', 'pref_place',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', on_delete=models.PROTECT, default=None, to=orm['places.Place'], blank=True, null=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'heroes.heropreferences': {
            ...
            'equipment_slot': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
