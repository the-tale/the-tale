...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hero.created_at_turn'
        db.add_column('heroes_hero', 'created_at_turn',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Hero.created_at_turn'
        db.delete_column('heroes_hero', 'created_at_turn')
