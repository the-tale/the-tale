...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Hero.messages'
        db.add_column('heroes_hero', 'messages', self.gf('django.db.models.fields.TextField')(default='[]'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Hero.messages'
        db.delete_column('heroes_hero', 'messages')
