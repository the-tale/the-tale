...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hero.stat_money_earned_from_help'
        db.add_column('heroes_hero', 'stat_money_earned_from_help',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Hero.stat_money_earned_from_help'
        db.delete_column('heroes_hero', 'stat_money_earned_from_help')
