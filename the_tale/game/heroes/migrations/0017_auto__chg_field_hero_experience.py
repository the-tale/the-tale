...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('heroes_hero', 'experience', self.gf('django.db.models.fields.FloatField')())
    def backwards(self, orm):

        # Changing field 'Hero.experience'
        db.alter_column('heroes_hero', 'experience', self.gf('django.db.models.fields.BigIntegerField')())
    models = {
        'accounts.account': {
