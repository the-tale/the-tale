...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Hero.name'
        db.alter_column('heroes_hero', 'name', self.gf('django.db.models.fields.CharField')(max_length=32))
    def backwards(self, orm):

        # Changing field 'Hero.name'
        db.alter_column('heroes_hero', 'name', self.gf('django.db.models.fields.CharField')(max_length=150))
    models = {
        'accounts.account': {
