...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Hero.actions_pvp_combat_style'
        db.delete_column('heroes_hero', 'actions_pvp_combat_style')

        # Deleting field 'Hero.actions_pvp_advantage'
        db.delete_column('heroes_hero', 'actions_pvp_advantage')
    ...
    def backwards(self, orm):
        # Adding field 'Hero.actions_pvp_combat_style'
        db.add_column('heroes_hero', 'actions_pvp_combat_style',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True),
                      keep_default=False)

        # Adding field 'Hero.actions_pvp_advantage'
        db.add_column('heroes_hero', 'actions_pvp_advantage',
    ...
    models = {
        ...
        'heroes.hero': {
            ...
            'pvp_advantage': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'pvp_combat_style': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True'}),
            'pvp_resource_concentration': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'pvp_resource_initiative': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'pvp_resource_rage': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
