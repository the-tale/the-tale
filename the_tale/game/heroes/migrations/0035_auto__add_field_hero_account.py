...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hero.account'
        db.add_column('heroes_hero', 'account',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='heroes', null=True, blank=True, to=orm['accounts.Account']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Hero.account'
        db.delete_column('heroes_hero', 'account_id')
