...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Hero.pref_enemy'
        db.alter_column(u'heroes_hero', 'pref_enemy_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['persons.Person'], null=True))

        # Changing field 'Hero.pos_place'
        db.alter_column(u'heroes_hero', 'pos_place_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['places.Place'], null=True))

        # Changing field 'Hero.pref_mob'
        db.alter_column(u'heroes_hero', 'pref_mob_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mobs.MobRecord'], null=True, on_delete=models.PROTECT))

        # Changing field 'Hero.pref_place'
        db.alter_column(u'heroes_hero', 'pref_place_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['places.Place'], null=True))

        # Changing field 'Hero.pos_road'
        db.alter_column(u'heroes_hero', 'pos_road_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['roads.Road'], null=True))

        # Changing field 'Hero.pref_friend'
        db.alter_column(u'heroes_hero', 'pref_friend_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['persons.Person'], null=True))

    def backwards(self, orm):

        # Changing field 'Hero.pref_enemy'
        db.alter_column(u'heroes_hero', 'pref_enemy_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['persons.Person']))

        # Changing field 'Hero.pos_place'
        db.alter_column(u'heroes_hero', 'pos_place_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['places.Place']))

        # Changing field 'Hero.pref_mob'
        db.alter_column(u'heroes_hero', 'pref_mob_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mobs.MobRecord'], null=True))

        # Changing field 'Hero.pref_place'
        db.alter_column(u'heroes_hero', 'pref_place_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['places.Place']))

        # Changing field 'Hero.pos_road'
        db.alter_column(u'heroes_hero', 'pos_road_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['roads.Road']))

        # Changing field 'Hero.pref_friend'
        db.alter_column(u'heroes_hero', 'pref_friend_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['persons.Person']))
