...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ChangeNameTask'
        db.create_table('heroes_changenametask', (
        ...
        db.send_create_signal('heroes', ['ChangeNameTask'])

        # Adding field 'Hero.name_forms'
        db.add_column('heroes_hero', 'name_forms',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Removing index on 'ChoosePreferencesTask', fields ['created_at']
        db.delete_index('heroes_choosepreferencestask', ['created_at'])

        # Adding field 'ChooseAbilityTask.created_at'
        db.add_column('heroes_chooseabilitytask', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2000, 1, 1, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding index on 'ChoosePreferencesTask', fields ['created_at']
        db.create_index('heroes_choosepreferencestask', ['created_at'])

        # Deleting model 'ChangeNameTask'
        db.delete_table('heroes_changenametask')

        # Deleting field 'Hero.name_forms'
        db.delete_column('heroes_hero', 'name_forms')

        # Deleting field 'ChooseAbilityTask.created_at'
        db.delete_column('heroes_chooseabilitytask', 'created_at')
    ...
    models = {
        ...
        'heroes.changenametask': {
            'Meta': {'object_name': 'ChangeNameTask'},
