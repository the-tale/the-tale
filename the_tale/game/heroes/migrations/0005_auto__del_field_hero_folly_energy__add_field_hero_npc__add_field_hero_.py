...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Hero.folly_energy'
        db.delete_column('heroes_hero', 'folly_energy')
        ...
        # Adding field 'Hero.alive'
        db.add_column('heroes_hero', 'alive', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Hero.health'
        db.add_column('heroes_hero', 'health', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)

        # Changing field 'Hero.angel'
        db.alter_column('heroes_hero', 'angel_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['angels.Angel']))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Hero.folly_energy'
        raise RuntimeError("Cannot reverse this migration. 'Hero.folly_energy' and its values cannot be restored.")

        # Deleting field 'Hero.npc'
        db.delete_column('heroes_hero', 'npc')

        # Deleting field 'Hero.alive'
        db.delete_column('heroes_hero', 'alive')

        # Deleting field 'Hero.health'
        db.delete_column('heroes_hero', 'health')

        # User chose to not deal with backwards NULL issues for 'Hero.angel'
        raise RuntimeError("Cannot reverse this migration. 'Hero.angel' and its values cannot be restored.")
    ...
    models = {
        ...
        'heroes.hero': {
            ...
            'angel': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'heroes'", 'null': 'True', 'to': "orm['angels.Angel']"}),
