...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Hero.bag'
        db.add_column('heroes_hero', 'bag', self.gf('django.db.models.fields.TextField')(default='{}'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Hero.bag'
        db.delete_column('heroes_hero', 'bag')
