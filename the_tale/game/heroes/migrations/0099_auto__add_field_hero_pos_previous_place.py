...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hero.pos_previous_place'
        db.add_column(u'heroes_hero', 'pos_previous_place',
    ...
    def backwards(self, orm):
        # Deleting field 'Hero.pos_previous_place'
        db.delete_column(u'heroes_hero', 'pos_previous_place_id')
