...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('heroes_choosepreferencestask', (
            ...
            ('preference_id', self.gf('django.db.models.fields.CharField')(default=None, max_length=32)),
        ...
        # Adding field 'Hero.pref_mob_id'
        db.add_column('heroes_hero', 'pref_mob_id',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Hero.pref_mob_id'
        db.delete_column('heroes_hero', 'pref_mob_id')
