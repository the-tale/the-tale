...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for hero in orm['heroes.Hero'].objects.all():
            ...
            if hero.level < 43 and 'equipment_slot' in preferences:
                del preferences['equipment_slot']

            if hero.level < 53 and 'mob' in preferences:
                del preferences['mob']

            hero.preferences = json.dumps(preferences)
            hero.save()
