...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Hero.pos_from_x'
        db.add_column('heroes_hero', 'pos_from_x', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'Hero.pos_from_y'
        db.add_column('heroes_hero', 'pos_from_y', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'Hero.pos_to_x'
        db.add_column('heroes_hero', 'pos_to_x', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'Hero.pos_to_y'
        db.add_column('heroes_hero', 'pos_to_y', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Hero.pos_from_x'
        db.delete_column('heroes_hero', 'pos_from_x')

        # Deleting field 'Hero.pos_from_y'
        db.delete_column('heroes_hero', 'pos_from_y')

        # Deleting field 'Hero.pos_to_x'
        db.delete_column('heroes_hero', 'pos_to_x')

        # Deleting field 'Hero.pos_to_y'
        db.delete_column('heroes_hero', 'pos_to_y')
