...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Hero.gender'
        db.add_column('heroes_hero', 'gender', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Hero.gender'
        db.delete_column('heroes_hero', 'gender')
