...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HeroPreferences'
        db.create_table(u'heroes_heropreferences', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('hero', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['heroes.Hero'])),
            ('energy_regeneration_type', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
            ('mob', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['mobs.MobRecord'], null=True, on_delete=models.PROTECT, blank=True)),
            ('place', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', on_delete=models.PROTECT, default=None, to=orm['places.Place'], blank=True, null=True)),
            ('friend', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', on_delete=models.PROTECT, default=None, to=orm['persons.Person'], blank=True, null=True)),
            ('enemy', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', on_delete=models.PROTECT, default=None, to=orm['persons.Person'], blank=True, null=True)),
            ('equipment_slot', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True)),
        ))
        db.send_create_signal(u'heroes', ['HeroPreferences'])


    def backwards(self, orm):
        # Deleting model 'HeroPreferences'
        db.delete_table(u'heroes_heropreferences')
