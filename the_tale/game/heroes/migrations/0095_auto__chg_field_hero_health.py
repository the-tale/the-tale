...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Hero.health'
        db.alter_column(u'heroes_hero', 'health', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Hero.health'
        db.alter_column(u'heroes_hero', 'health', self.gf('django.db.models.fields.FloatField')())
