...
class Migration(SchemaMigration):
    ...
    depends_on = (
        ("mobs", "0009_auto__add_mobrecord"),
    )

    def forwards(self, orm):
        # Adding field 'Hero.pref_mob'
        db.add_column('heroes_hero', 'pref_mob',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['mobs.MobRecord'], null=True, blank=True),
                      keep_default=False)
