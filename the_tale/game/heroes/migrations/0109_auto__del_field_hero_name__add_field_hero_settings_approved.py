...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Hero.settings_approved'
        db.add_column(u'heroes_hero', 'settings_approved',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Hero.name'
        raise RuntimeError("Cannot reverse this migration. 'Hero.name' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Hero.name'
        db.add_column(u'heroes_hero', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=32),
                      keep_default=False)

        # Deleting field 'Hero.settings_approved'
        db.delete_column(u'heroes_hero', 'settings_approved')
