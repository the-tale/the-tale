...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ChoosePreferencesTask.preference_id'
        db.alter_column('heroes_choosepreferencestask', 'preference_id', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ChoosePreferencesTask.preference_id'
        raise RuntimeError("Cannot reverse this migration. 'ChoosePreferencesTask.preference_id' and its values cannot be restored.")
    models = {
        'accounts.account': {
