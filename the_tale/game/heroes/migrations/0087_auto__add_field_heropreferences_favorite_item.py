...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HeroPreferences.favorite_item'
        db.add_column(u'heroes_heropreferences', 'favorite_item',
                      self.gf('rels.django_staff.TableIntegerField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HeroPreferences.favorite_item'
        db.delete_column(u'heroes_heropreferences', 'favorite_item')
