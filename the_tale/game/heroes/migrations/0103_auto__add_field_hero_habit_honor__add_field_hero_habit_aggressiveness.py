...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hero.habit_honor'
        db.add_column(u'heroes_hero', 'habit_honor',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Hero.habit_aggressiveness'
        db.add_column(u'heroes_hero', 'habit_aggressiveness',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Hero.habit_honor'
        db.delete_column(u'heroes_hero', 'habit_honor')

        # Deleting field 'Hero.habit_aggressiveness'
        db.delete_column(u'heroes_hero', 'habit_aggressiveness')
    ...
    models = {
        ...
        u'heroes.hero': {
            ...
            'habit_aggressiveness': ('django.db.models.fields.FloatField', [], {'default': '0'}),
