...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hero.ui_caching_started_at'
        db.add_column('heroes_hero', 'ui_caching_started_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2000, 1, 1, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Hero.ui_caching_started_at'
        db.delete_column('heroes_hero', 'ui_caching_started_at')
