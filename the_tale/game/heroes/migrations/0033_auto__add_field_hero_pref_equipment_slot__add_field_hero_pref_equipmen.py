...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('heroes_hero', 'pref_equipment_slot',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=16, null=True),
                      keep_default=False)

        # Adding field 'Hero.pref_equipment_slot_changed_at'
        db.add_column('heroes_hero', 'pref_equipment_slot_changed_at',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('heroes_hero', 'pref_equipment_slot')

        # Deleting field 'Hero.pref_equipment_slot_changed_at'
        db.delete_column('heroes_hero', 'pref_equipment_slot_changed_at')
    ...
    models = {
        ...
        'heroes.hero': {
            ...
            'pref_equipment_slot': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '16', 'null': 'True'}),
