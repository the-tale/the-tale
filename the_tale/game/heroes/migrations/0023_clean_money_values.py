...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        orm.Hero.objects.all().update( money=0,
                                       stat_money_earned_from_loot=0,
                                       stat_money_earned_from_artifacts=0,
                                       stat_money_earned_from_quests=0,
                                       stat_money_earned_from_help=0,

                                       stat_money_spend_for_heal=0,
                                       stat_money_spend_for_artifacts=0,
                                       stat_money_spend_for_sharpening=0,
                                       stat_money_spend_for_useless=0,
                                       stat_money_spend_for_impact=0 )
