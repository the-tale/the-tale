...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for hero in orm['heroes.Hero'].objects.all():
            descriptions = json.loads(hero.actions_descriptions)

            actions = {'actions': [{'percents': 0.0,
                                    'description': description,
                                    'info_link': None} for description in descriptions]}
            actions['actions'][-1]['percents'] = hero.last_action_percents
