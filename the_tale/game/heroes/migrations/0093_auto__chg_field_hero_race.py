...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Hero.race'
        db.alter_column(u'heroes_hero', 'race', self.gf('rels.django_staff.TableIntegerField')())

    def backwards(self, orm):

        # Changing field 'Hero.race'
        db.alter_column(u'heroes_hero', 'race', self.gf('django.db.models.fields.IntegerField')())
