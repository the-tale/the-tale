...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Hero.energy'
        db.alter_column(u'heroes_hero', 'energy', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Hero.energy'
        db.alter_column(u'heroes_hero', 'energy', self.gf('django.db.models.fields.FloatField')())
