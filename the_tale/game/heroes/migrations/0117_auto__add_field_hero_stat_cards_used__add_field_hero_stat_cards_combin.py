...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hero.stat_cards_used'
        db.add_column(u'heroes_hero', 'stat_cards_used',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Hero.stat_cards_combined'
        db.add_column(u'heroes_hero', 'stat_cards_combined',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Hero.stat_cards_used'
        db.delete_column(u'heroes_hero', 'stat_cards_used')

        # Deleting field 'Hero.stat_cards_combined'
        db.delete_column(u'heroes_hero', 'stat_cards_combined')
