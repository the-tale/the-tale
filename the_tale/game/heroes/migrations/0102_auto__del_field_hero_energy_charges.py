...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Hero.energy_charges'
        db.delete_column(u'heroes_hero', 'energy_charges')


    def backwards(self, orm):
        # Adding field 'Hero.energy_charges'
        db.add_column(u'heroes_hero', 'energy_charges',
