...
class PvPData(object):
    ...
    def __init__(self):
        ...
        self._effectiveness_modified = 0
        self._rage = 0
        self._initiative = 0
        ...
        self.turn_effectiveness_modified = 0
        self.turn_rage = 0
    ...
    def get_effectiveness_modified(self): return self._effectiveness_modified
    def set_effectiveness_modified(self, value): self.updated = True; self._effectiveness_modified = value
    effectiveness_modified = property(get_effectiveness_modified, set_effectiveness_modified)
    ...
    def serialize(self):
        return {'combat_style': self._combat_style,
                ...
                'effectiveness_modified': self._effectiveness_modified,
                'rage': self._rage,
                ...
                'turn_effectiveness_modified': self.turn_effectiveness_modified,
    ...
    def deserialize(cls, data):
        ...
        obj._effectiveness_modified = data.get('effectiveness_modified', 0)
        ...
        obj.turn_effectiveness_modified = data.get('turn_effectiveness_modified', 0)
    ...
    def ui_info(self):
        return  { 'combat_style': COMBAT_STYLES[self.combat_style].str_id.lower() if self.combat_style is not None else None,
                  'advantage': self.advantage,
                  'effectiveness': self.effectiveness,
                  'effectiveness_modified': self.effectiveness_modified,
                  'rage': self.rage,
                  'initiative': self.initiative,
                  'concentration': self.concentration }

    def turn_ui_info(self):
        return  { 'combat_style': COMBAT_STYLES[self.turn_combat_style].str_id.lower() if self.turn_combat_style is not None else None,
                  'advantage': self.turn_advantage,
                  'effectiveness': self.turn_effectiveness,
                  'effectiveness_modified': self.turn_effectiveness_modified,
                  'rage': self.turn_rage,
    ...
    def store_turn_data(self):
        ...
        self.turn_effectiveness_modified = self._effectiveness_modified
