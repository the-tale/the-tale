...
class COHERENCE(AbilityPrototype):
    ...
    NAME = u'Товарищ'
    normalized_name = NAME
    DESCRIPTION = u'Путешествия со спутником сложны и требуют от героя особых навыков. Умение по-товарищески относиться к спутнику определяет максимальную слаженность спутника. Она увеличивается на 20 за уровень способности. При сбросе навыка, зарабатотанная слаженность не теряется, но ограничивается его акутальным значением.'
