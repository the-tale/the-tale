...
class MAGE(AbilityModifiersBase):
    ...
    DESCRIPTION = u'Маг всё своё усердие направляет в совершенствование магических умений, поэтому имеет увеличенный магический урон, защиту от магии и уменьшенные физический урон и защиту от физических атак.'
...
class WARRIOR(AbilityModifiersBase):
    ...
    NAME = u'Воин'
    normalized_name = NAME
    DESCRIPTION = u'Воин большую часть времени тратит на физические тренировки, благодаря чему наносит больший физический урон, имеет хорошую защиту от физических атак, но слабо противостоит магии и сам с трудом ей пользуется.'
