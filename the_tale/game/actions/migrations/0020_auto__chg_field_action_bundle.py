...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Action.bundle'
        db.alter_column('actions_action', 'bundle_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['game.Bundle']))
    def backwards(self, orm):

        # Changing field 'Action.bundle'
        db.alter_column('actions_action', 'bundle_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['game.Bundle'], null=True))
    models = {
        'accounts.account': {
