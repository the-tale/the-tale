...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MetaAction'
        db.create_table('actions_metaaction', (
        ...
        db.send_create_signal('actions', ['MetaAction'])

        # Adding model 'MetaActionMember'
        db.create_table('actions_metaactionmember', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('hero', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['heroes.Hero'])),
            ('action', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['actions.MetaAction'])),
            ('context', self.gf('django.db.models.fields.TextField')(default='{}')),
            ('role', self.gf('django.db.models.fields.CharField')(max_length=32)),
        ))
        db.send_create_signal('actions', ['MetaActionMember'])

        # Adding field 'Action.meta_action'
        db.add_column('actions_action', 'meta_action',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['actions.MetaAction'], null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting model 'MetaAction'
        db.delete_table('actions_metaaction')

        # Deleting model 'MetaActionMember'
        db.delete_table('actions_metaactionmember')

        # Deleting field 'Action.meta_action'
        db.delete_column('actions_action', 'meta_action_id')
