...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Action.npc'
        db.delete_column('actions_action', 'npc_id')


    def backwards(self, orm):
        
        # Adding field 'Action.npc'
        db.add_column('actions_action', 'npc', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['heroes.Hero'], blank=True), keep_default=False)
