...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MetaAction.bundle'
        db.add_column(u'actions_metaaction', 'bundle',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['game.Bundle'], null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'MetaAction.bundle'
        db.delete_column(u'actions_metaaction', 'bundle_id')
