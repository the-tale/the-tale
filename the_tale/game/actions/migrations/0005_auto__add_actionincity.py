...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ActionInCity'
        db.create_table('actions_actionincity', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('base_action', self.gf('django.db.models.fields.related.OneToOneField')(related_name='action_in_city', unique=True, to=orm['actions.Action'])),
            ('hero', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['heroes.Hero'])),
            ('city', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['places.Place'])),
        ))
        db.send_create_signal('actions', ['ActionInCity'])


    def backwards(self, orm):
        
        # Deleting model 'ActionInCity'
        db.delete_table('actions_actionincity')
