...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Action.bundle'
        db.add_column('actions_action', 'bundle',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['game.Bundle'], null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Action.bundle'
        db.delete_column('actions_action', 'bundle_id')
