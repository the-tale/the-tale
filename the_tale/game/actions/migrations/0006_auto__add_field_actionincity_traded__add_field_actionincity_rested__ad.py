...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ActionInCity.traded'
        db.add_column('actions_actionincity', 'traded', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ActionInCity.rested'
        db.add_column('actions_actionincity', 'rested', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ActionInCity.equipped'
        db.add_column('actions_actionincity', 'equipped', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ActionInCity.traded'
        db.delete_column('actions_actionincity', 'traded')

        # Deleting field 'ActionInCity.rested'
        db.delete_column('actions_actionincity', 'rested')

        # Deleting field 'ActionInCity.equipped'
        db.delete_column('actions_actionincity', 'equipped')
