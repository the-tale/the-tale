...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MetaAction.type'
        db.delete_column(u'actions_metaaction', 'type')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'MetaAction.type'
        raise RuntimeError("Cannot reverse this migration. 'MetaAction.type' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'MetaAction.type'
        db.add_column(u'actions_metaaction', 'type',
