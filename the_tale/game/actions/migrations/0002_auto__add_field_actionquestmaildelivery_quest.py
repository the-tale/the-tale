...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ActionQuestMailDelivery.quest'
        db.add_column('actions_actionquestmaildelivery', 'quest', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', null=True, to=orm['quests.Quest']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ActionQuestMailDelivery.quest'
        db.delete_column('actions_actionquestmaildelivery', 'quest_id')
