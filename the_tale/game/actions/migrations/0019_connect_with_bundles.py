...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for action_model in orm['actions.Action'].objects.all():
            hero_model = orm['heroes.Hero'].objects.get(id=action_model.hero_id)
            bundle_member = orm['game.BundleMember'].objects.select_related().get(account_id=hero_model.account_id)
            action_model.bundle = bundle_member.bundle
            action_model.save()
    ...
    models = {
        ...
        'actions.action': {
            ...
            'bundle': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['game.Bundle']", 'null': 'True'}),
