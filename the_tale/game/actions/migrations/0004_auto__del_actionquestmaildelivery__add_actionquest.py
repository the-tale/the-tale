...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ActionQuest'
        db.create_table('actions_actionquest', (
            ...
            ('quest', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', null=True, to=orm['quests.Quest'])),
            ('quest_action', self.gf('django.db.models.fields.related.OneToOneField')(default=None, related_name='+', unique=True, null=True, to=orm['actions.Action'])),
        ))
        db.send_create_signal('actions', ['ActionQuest'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ActionQuest'
        db.delete_table('actions_actionquest')
