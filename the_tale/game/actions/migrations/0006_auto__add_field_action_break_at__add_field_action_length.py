...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Action.break_at'
        db.add_column('actions_action', 'break_at', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'Action.length'
        db.add_column('actions_action', 'length', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Action.break_at'
        db.delete_column('actions_action', 'break_at')

        # Deleting field 'Action.length'
        db.delete_column('actions_action', 'length')
