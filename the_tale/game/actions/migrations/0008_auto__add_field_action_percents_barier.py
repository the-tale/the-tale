...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Action.percents_barier'
        db.add_column('actions_action', 'percents_barier', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Action.percents_barier'
        db.delete_column('actions_action', 'percents_barier')
