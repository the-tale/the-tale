...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Action.destination_x'
        db.add_column('actions_action', 'destination_x', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'Action.destination_y'
        db.add_column('actions_action', 'destination_y', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Action.destination_x'
        db.delete_column('actions_action', 'destination_x')

        # Deleting field 'Action.destination_y'
        db.delete_column('actions_action', 'destination_y')
