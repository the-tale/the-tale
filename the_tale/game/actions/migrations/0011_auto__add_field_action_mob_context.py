...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Action.mob_context'
        db.add_column('actions_action', 'mob_context', self.gf('django.db.models.fields.TextField')(default='{}'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Action.mob_context'
        db.delete_column('actions_action', 'mob_context')
