...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Action.road'
        db.delete_column('actions_action', 'road_id')

    def backwards(self, orm):
        # Adding field 'Action.road'
        db.add_column('actions_action', 'road',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['roads.Road'], blank=True),
                      keep_default=False)
