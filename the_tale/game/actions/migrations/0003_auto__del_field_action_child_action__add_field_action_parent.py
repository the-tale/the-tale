...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Action.child_action'
        db.delete_column('actions_action', 'child_action_id')

        # Adding field 'Action.parent'
        db.add_column('actions_action', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['actions.Action']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Action.child_action'
        db.add_column('actions_action', 'child_action', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['actions.Action']), keep_default=False)

        # Deleting field 'Action.parent'
        db.delete_column('actions_action', 'parent_id')
    ...
    models = {
        ...
        'actions.action': {
            ...
            'npc': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['heroes.Hero']"}),
