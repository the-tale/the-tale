...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Action.npc'
        db.alter_column('actions_action', 'npc_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['heroes.Hero']))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Action.npc'
        raise RuntimeError("Cannot reverse this migration. 'Action.npc' and its values cannot be restored.")
    ...
    models = {
        ...
        'actions.action': {
            ...
            'npc': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['heroes.Hero']"}),
