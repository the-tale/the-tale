...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Action.entropy'
        db.delete_column('actions_action', 'entropy')


    def backwards(self, orm):
        
        # Adding field 'Action.entropy'
        db.add_column('actions_action', 'entropy', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
