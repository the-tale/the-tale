...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for meta_action in orm['actions.MetaAction'].objects.all():
            bundle_id = orm['actions.Action'].filter(meta_action_id=meta_action.id)[0].bundle_id
            meta_action.bundle_id = bundle_id
            meta_action.save()
