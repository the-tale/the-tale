...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SupervisorTaskMember'
        db.create_table('game_supervisortaskmember', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['game.SupervisorTask'])),
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['accounts.Account'])),
        ))
        db.send_create_signal('game', ['SupervisorTaskMember'])

        # Adding model 'SupervisorTask'
        db.create_table('game_supervisortask', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('type', self.gf('django.db.models.fields.IntegerField')()),
            ('state', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('game', ['SupervisorTask'])

    def backwards(self, orm):
        # Deleting model 'SupervisorTaskMember'
        db.delete_table('game_supervisortaskmember')

        # Deleting model 'SupervisorTask'
        db.delete_table('game_supervisortask')
