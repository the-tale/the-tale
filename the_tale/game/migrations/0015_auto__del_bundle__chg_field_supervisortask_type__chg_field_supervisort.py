...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'game_bundle')


        # Changing field 'SupervisorTask.type'
        db.alter_column(u'game_supervisortask', 'type', self.gf('rels.django.RelationIntegerField')())

        # Changing field 'SupervisorTask.state'
        db.alter_column(u'game_supervisortask', 'state', self.gf('rels.django.RelationIntegerField')())

    def backwards(self, orm):
        # Adding model 'Bundle'
        db.create_table(u'game_bundle', (
            ('owner', self.gf('django.db.models.fields.CharField')(max_length=32, null=True)),
        ...
        db.send_create_signal(u'game', ['Bundle'])


        # Changing field 'SupervisorTask.type'
        db.alter_column(u'game_supervisortask', 'type', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'SupervisorTask.state'
        db.alter_column(u'game_supervisortask', 'state', self.gf('django.db.models.fields.IntegerField')())
