...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BundleMember.created_at'
        db.add_column('game_bundlemember', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2000, 1, 1, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'Bundle.created_at'
        db.add_column('game_bundle', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2000, 1, 1, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'BundleMember.created_at'
        db.delete_column('game_bundlemember', 'created_at')

        # Deleting field 'Bundle.created_at'
        db.delete_column('game_bundle', 'created_at')
