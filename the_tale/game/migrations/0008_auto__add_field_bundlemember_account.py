...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BundleMember.account'
        db.add_column('game_bundlemember', 'account',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', unique=True, null=True, to=orm['accounts.Account']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'BundleMember.account'
        db.delete_column('game_bundlemember', 'account_id')
    ...
    models = {
        ...
        'game.bundlemember': {
            ...
            'account': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'unique': 'True', 'null': 'True', 'to': "orm['accounts.Account']"}),
