...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'game.bundle': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'members': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['game.BundleMember']", 'symmetrical': 'False'}),
            'owner': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True'}),
            'type': ('django.db.models.fields.IntegerField', [], {})
        },
        'game.bundlemember': {
            'Meta': {'object_name': 'BundleMember'},
            'angel': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'bundle'", 'null': 'True', 'to': "orm['angels.Angel']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        }
    }
