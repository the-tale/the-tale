...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BundleMember.angel'
        db.delete_column('game_bundlemember', 'angel_id')


        # Changing field 'BundleMember.account'
        db.alter_column('game_bundlemember', 'account_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, unique=True, to=orm['accounts.Account']))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'BundleMember.angel'
        raise RuntimeError("Cannot reverse this migration. 'BundleMember.angel' and its values cannot be restored.")

        # Changing field 'BundleMember.account'
        db.alter_column('game_bundlemember', 'account_id', self.gf('django.db.models.fields.related.ForeignKey')(unique=True, null=True, to=orm['accounts.Account']))
    models = {
        'accounts.account': {
        ...
        'game.bundlemember': {
            ...
            'account': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'unique': 'True', 'to': "orm['accounts.Account']"}),
