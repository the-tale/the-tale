...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'QuestMailDelivery.action_delivery_from'
        db.delete_column('quests_questmaildelivery', 'action_delivery_from_id')

        # Deleting field 'QuestMailDelivery.action_delivery'
        db.delete_column('quests_questmaildelivery', 'action_delivery_id')

        # Adding field 'Quest.percents'
        db.add_column('quests_quest', 'percents', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'QuestMailDelivery.action_delivery_from'
        db.add_column('quests_questmaildelivery', 'action_delivery_from', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', null=True, to=orm['actions.Action']), keep_default=False)

        # Adding field 'QuestMailDelivery.action_delivery'
        db.add_column('quests_questmaildelivery', 'action_delivery', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', null=True, to=orm['actions.Action']), keep_default=False)

        # Deleting field 'Quest.percents'
        db.delete_column('quests_quest', 'percents')
