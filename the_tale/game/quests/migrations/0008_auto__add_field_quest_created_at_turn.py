...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quest.created_at_turn'
        db.add_column('quests_quest', 'created_at_turn',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Quest.created_at_turn'
        db.delete_column('quests_quest', 'created_at_turn')
