...
class LineTest(TestCase):
    ...
    def test_get_quest_command(self):
        ...
        self.assertEqual(self.choice_line.get_quest_command(self.env, [1, 'line_1', 0]), (cmd_linear_move, []))
        self.assertEqual(self.choice_line.get_quest_command(self.env, [1, 'line_1', 7]), (cmd_linear_give_power, []))
        self.assertEqual(self.choice_line.get_quest_command(self.env, [1, 'line_1', 7, 8]), (cmd_linear_give_power, [8]))
        self.assertRaises(QuestGeneratorException, self.choice_line.get_quest_command, self.env, [1, 'line_1', 8])
        self.assertEqual(self.choice_line.get_quest_command(self.env, [1, 'line_2', 0]), (cmd_quest_move, []))
        self.assertEqual(self.choice_line.get_quest_command(self.env, [1, 'line_2', 1]), (cmd_quest_quest, []))
        self.assertEqual(self.choice_line.get_quest_command(self.env, [1, 'line_2', 1, 0]), (cmd_quest_quest, [0]))
        self.assertEqual(self.choice_line.get_quest_command(self.env, [1, 'line_2', 1, 2]), (cmd_quest_quest, [2]))
        self.assertEqual(self.choice_line.get_quest_command(self.env, [1, 'line_2', 2]), (cmd_quest_get_reward, []))
