...
ARTIFACTS_RECEIVING_SPEED = ARTIFACTS_LOOT_PER_DAY # количество получаемых артефактов в день
ARTIFACTS_BREAKING_SPEED = ARTIFACTS_RECEIVING_SPEED / 2 # количество поломок артефактов в день
...
EXP_FOR_PREMIUM_ACCOUNT = float(0.8) # модификатор опыта для премиум аккаунтов
EXP_FOR_NORMAL_ACCOUNT = float(0.528) # модификатор опыта для обычных акканутов
