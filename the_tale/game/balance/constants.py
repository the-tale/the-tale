...
HERO_MOVE_SPEED = float(30) # базовая скорость героя расстояние в ход
...
BATTLES_PER_TURN = 0 #float(1.0 / (INTERVAL_BETWEEN_BATTLES + 1) )
...
# Задания
QUESTS_SPECIAL_FRACTION = float(1.0) # вероятность получить "специальное" задание - задание обусловленное параметрами героя, а не внешним миром.
