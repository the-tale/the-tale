...
POSITIVE_NEGATIVE_POWER_RELATION = float(4.0) # желаемое отношение позитивного влияния к негативному, если не совпадает, корректируем, добавляя необходимое
...
PLACE_HABITS_EVENT_PROBABILITY = float(0.001)
...
COMPANIONS_HEALTH_PER_HEAL = int(1) # лечение спутника за одно действие ухода за спутником
COMPANIONS_DAMAGE_PER_WOUND = int(1) # урон спутнику за ранение
...
COMPANION_EATEN_CORPSES_HEAL_AMOUNT = int(1)
COMPANION_REGEN_ON_HEAL_AMOUNT = int(2)
COMPANION_REGEN_BY_HERO = int(2)

COMPANION_EATEN_CORPSES_PER_BATTLE = float(COMPANIONS_REGEN_PER_HOUR) / BATTLES_PER_HOUR / COMPANION_EATEN_CORPSES_HEAL_AMOUNT
COMPANION_REGEN_ON_HEAL_PER_HEAL = float(COMPANIONS_REGEN_PER_HOUR) / _COMPANIONS_MEDIUM_HEALS_IN_HOUR / COMPANION_REGEN_ON_HEAL_AMOUNT
COMPANION_HERO_REGEN_ON_HEAL_PER_HEAL = float(COMPANIONS_REGEN_PER_HOUR) / _COMPANIONS_MEDIUM_HEALS_IN_HOUR / COMPANION_REGEN_BY_HERO
