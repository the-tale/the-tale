...
EXP_PENALTY_MULTIPLIER = float(3) # во сколько раз будет замедлена прокачка неактивных героев
EXP_ACTIVE_STATE_LENGTH = int(2 * 24 * TURNS_IN_HOUR) # длительность бафа на нормальное получение опыта героями
