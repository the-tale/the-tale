...
QUESTS_SOCIAL_CONNECTIONS_FRACTION = float(0.05) # вероятность, что новое задание будет создано на основе социальной связи
...
COMPANIONS_EXP_PER_HEAL = int(EXP_PER_HOUR * COMPANIONS_BONUS_EXP_FRACTION / ((COMPANIONS_HEAL_MIN_IN_HOUR+COMPANIONS_HEAL_MAX_IN_HOUR) / 2))
...
COMPANIONS_REGEN_BY_HERO = int(2)
...
COMPANIONS_REGEN_ON_HEAL_PER_HEAL = float(COMPANIONS_REGEN_PER_HOUR) / _COMPANIONS_MEDIUM_HEALS_IN_HOUR / COMPANIONS_REGEN_ON_HEAL_AMOUNT
