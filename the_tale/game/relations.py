...
class RACE(DjangoEnum):
    ...
    records = ( ('HUMAN', 0, u'человек', u'люди', e.ANGEL_ENERGY_REGENERATION_TYPES.PRAY, technical_words.RACE_HUMANS),
                 ('ELF', 1, u'эльф', u'эльфы', e.ANGEL_ENERGY_REGENERATION_TYPES.INCENSE, technical_words.RACE_ELFS),
                 ('ORC', 2, u'орк',  u'орки', e.ANGEL_ENERGY_REGENERATION_TYPES.SACRIFICE, technical_words.RACE_ORCS),
                 ('GOBLIN', 3, u'гоблин', u'гоблины', e.ANGEL_ENERGY_REGENERATION_TYPES.MEDITATION, technical_words.RACE_GOBLINS),
                 ('DWARF', 4, u'дварф', u'дварфы', e.ANGEL_ENERGY_REGENERATION_TYPES.SYMBOLS, technical_words.RACE_DWARFS) )
