...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RecordToActor.actor'
        db.alter_column(u'chronicle_recordtoactor', 'actor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chronicle.Actor'], on_delete=models.PROTECT))

        # Changing field 'Actor.person'
        db.alter_column(u'chronicle_actor', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['persons.Person']))

        # Changing field 'Actor.bill'
        db.alter_column(u'chronicle_actor', 'bill_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['bills.Bill']))

        # Changing field 'Actor.place'
        db.alter_column(u'chronicle_actor', 'place_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['places.Place']))

    def backwards(self, orm):

        # Changing field 'RecordToActor.actor'
        db.alter_column(u'chronicle_recordtoactor', 'actor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chronicle.Actor']))

        # Changing field 'Actor.person'
        db.alter_column(u'chronicle_actor', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['persons.Person']))

        # Changing field 'Actor.bill'
        db.alter_column(u'chronicle_actor', 'bill_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['bills.Bill']))

        # Changing field 'Actor.place'
        db.alter_column(u'chronicle_actor', 'place_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['places.Place']))
    ...
    models = {
        ...
        u'chronicle.actor': {
            ...
            'bill': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['bills.Bill']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'person': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['persons.Person']"}),
            'place': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['places.Place']"}),
            'uid': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '16'})
        },
        u'chronicle.record': {
            'Meta': {'object_name': 'Record'},
            'actors': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['chronicle.Actor']", 'through': u"orm['chronicle.RecordToActor']", 'symmetrical': 'False'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_at_turn': ('django.db.models.fields.IntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
