...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('chronicle_record', 'type', self.gf('rels.django_staff.TableIntegerField')())
    def backwards(self, orm):

        # Changing field 'Record.type'
        db.alter_column('chronicle_record', 'type', self.gf('django.db.models.fields.IntegerField')())
    models = {
        'accounts.account': {
