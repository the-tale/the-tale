...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RecordToActor'
        db.create_table('chronicle_recordtoactor', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('role', self.gf('django.db.models.fields.IntegerField')()),
            ('record', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chronicle.Record'])),
            ('actor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chronicle.Actor'])),
        ))
        db.send_create_signal('chronicle', ['RecordToActor'])

        # Adding model 'Actor'
        db.create_table('chronicle_actor', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=16)),
            ('bill', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['bills.Bill'])),
            ('place', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['places.Place'])),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['persons.Person'])),
        ))
        db.send_create_signal('chronicle', ['Actor'])

    def backwards(self, orm):
        # Deleting model 'RecordToActor'
        db.delete_table('chronicle_recordtoactor')

        # Deleting model 'Actor'
        db.delete_table('chronicle_actor')
    ...
    models = {
        ...
        'chronicle.actor': {
            ...
            'bill': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['bills.Bill']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'person': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['persons.Person']"}),
        ...
        'chronicle.record': {
            ...
            'actors': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['chronicle.Actor']", 'through': "orm['chronicle.RecordToActor']", 'symmetrical': 'False'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_at_turn': ('django.db.models.fields.IntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
