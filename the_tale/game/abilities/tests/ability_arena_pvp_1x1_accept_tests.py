...
from game.abilities.deck.arena_pvp_1x1_accept import ArenaPvP1x1Accept, ABILITY_TASK_STEP
...
class ArenaPvP1x1LeaveQueueAbilityTest(ArenaPvP1x1AcceptBaseTests):
    ...
    def process_ability(self, success=True):
        ...
        if success:
            ...
            self.assertEqual((result, step, postsave_actions), (False, ABILITY_TASK_STEP.ERROR, ()))
