...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AbilityTask.comment'
        db.add_column('abilities_abilitytask', 'comment',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'AbilityTask.comment'
        db.delete_column('abilities_abilitytask', 'comment')
