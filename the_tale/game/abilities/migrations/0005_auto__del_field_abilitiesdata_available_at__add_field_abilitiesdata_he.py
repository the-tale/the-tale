...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AbilitiesData.available_at'
        db.delete_column('abilities_abilitiesdata', 'available_at')

        # Adding field 'AbilitiesData.help_available_at'
        db.add_column('abilities_abilitiesdata', 'help_available_at',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'AbilitiesData.available_at'
        db.add_column('abilities_abilitiesdata', 'available_at',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'AbilitiesData.help_available_at'
        db.delete_column('abilities_abilitiesdata', 'help_available_at')

    models = {
        'abilities.abilitiesdata': {
            'Meta': {'object_name': 'AbilitiesData'},
            'help_available_at': ('django.db.models.fields.BigIntegerField', [], {'default': '0'}),
