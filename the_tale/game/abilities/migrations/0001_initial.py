...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AbilityTask'
        db.create_table('abilities_abilitytask', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('state', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('angel', self.gf('django.db.models.fields.related.ForeignKey')(related_name='abilities_in_use', to=orm['angels.Angel'])),
            ('hero', self.gf('django.db.models.fields.related.ForeignKey')(related_name='abilities_in_use', to=orm['heroes.Hero'])),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('activated_at', self.gf('django.db.models.fields.IntegerField')()),
            ('available_at', self.gf('django.db.models.fields.IntegerField')()),
            ('data', self.gf('django.db.models.fields.TextField')(default='{}')),
        ))
        db.send_create_signal('abilities', ['AbilityTask'])


    def backwards(self, orm):
        
        # Deleting model 'AbilityTask'
        db.delete_table('abilities_abilitytask')


    models = {
        'abilities.abilitytask': {
            'Meta': {'object_name': 'AbilityTask'},
            'activated_at': ('django.db.models.fields.IntegerField', [], {}),
            'angel': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'abilities_in_use'", 'to': "orm['angels.Angel']"}),
            'available_at': ('django.db.models.fields.IntegerField', [], {}),
            'data': ('django.db.models.fields.TextField', [], {'default': "'{}'"}),
            'hero': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'abilities_in_use'", 'to': "orm['heroes.Hero']"}),
