...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AbilityTask.angel'
        db.delete_column('abilities_abilitytask', 'angel_id')

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'AbilityTask.angel'
        raise RuntimeError("Cannot reverse this migration. 'AbilityTask.angel' and its values cannot be restored.")
    models = {
