...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AbilitiesData.arena_pvp_1x1_available_at'
        db.add_column('abilities_abilitiesdata', 'arena_pvp_1x1_available_at',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'AbilitiesData.arena_pvp_1x1_available_at'
        db.delete_column('abilities_abilitiesdata', 'arena_pvp_1x1_available_at')

    models = {
        'abilities.abilitiesdata': {
            'Meta': {'object_name': 'AbilitiesData'},
            'arena_pvp_1x1_available_at': ('django.db.models.fields.BigIntegerField', [], {'default': '0'}),
