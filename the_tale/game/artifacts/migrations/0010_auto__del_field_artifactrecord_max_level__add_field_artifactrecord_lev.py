...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ArtifactRecord.max_level'
        db.delete_column('artifacts_artifactrecord', 'max_level')

        # Adding field 'ArtifactRecord.level'
        db.add_column('artifacts_artifactrecord', 'level',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        if not db.dry_run:
            for record in orm['artifacts.ArtifactRecord'].objects.all():
                record.level = record.min_level
                record.save()

    def backwards(self, orm):
        # Adding field 'ArtifactRecord.max_level'
        db.add_column('artifacts_artifactrecord', 'max_level',
                      self.gf('django.db.models.fields.IntegerField')(default=99999),
                      keep_default=False)

        # Deleting field 'ArtifactRecord.level'
        db.delete_column('artifacts_artifactrecord', 'level')
    ...
    models = {
        ...
        'artifacts.artifactrecord': {
            ...
            'editor': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['accounts.Account']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'level': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'min_level': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'mob': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['mobs.MobRecord']"}),
