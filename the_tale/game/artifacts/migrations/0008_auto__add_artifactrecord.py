...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ArtifactRecord'
        db.create_table('artifacts_artifactrecord', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('editor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['accounts.Account'])),
            ('type', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('rarity', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ...
            ('max_level', self.gf('django.db.models.fields.IntegerField')(default=99999)),
            ...
            ('name_forms', self.gf('django.db.models.fields.TextField')()),
            ('description', self.gf('django.db.models.fields.TextField')(default=u'')),
        ))
        db.send_create_signal('artifacts', ['ArtifactRecord'])

    def backwards(self, orm):
        # Deleting model 'ArtifactRecord'
        db.delete_table('artifacts_artifactrecord')
    ...
    models = {
        ...
        'artifacts.artifactrecord': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'max_level': ('django.db.models.fields.IntegerField', [], {'default': '99999'}),
