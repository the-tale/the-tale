...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ArtifactRecord.name_forms'
        db.delete_column(u'artifacts_artifactrecord', 'name_forms')


    def backwards(self, orm):
        # Adding field 'ArtifactRecord.name_forms'
        db.add_column(u'artifacts_artifactrecord', 'name_forms',
