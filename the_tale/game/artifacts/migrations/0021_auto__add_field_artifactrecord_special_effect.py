...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArtifactRecord.special_effect'
        db.add_column(u'artifacts_artifactrecord', 'special_effect',
                      self.gf('rels.django.RelationIntegerField')(default=666),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArtifactRecord.special_effect'
        db.delete_column(u'artifacts_artifactrecord', 'special_effect')
