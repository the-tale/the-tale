...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ArtifactRecord.rarity'
        db.delete_column(u'artifacts_artifactrecord', 'rarity')

        # Adding field 'ArtifactRecord.power_type'
        db.add_column(u'artifacts_artifactrecord', 'power_type',
                      self.gf('rels.django.RelationIntegerField')(default=2),
                      keep_default=False)


        # Changing field 'ArtifactRecord.state'
        db.alter_column(u'artifacts_artifactrecord', 'state', self.gf('rels.django.RelationIntegerField')())

        # Changing field 'ArtifactRecord.type'
        db.alter_column(u'artifacts_artifactrecord', 'type', self.gf('rels.django.RelationIntegerField')())

    def backwards(self, orm):
        # Adding field 'ArtifactRecord.rarity'
        db.add_column(u'artifacts_artifactrecord', 'rarity',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'ArtifactRecord.power_type'
        db.delete_column(u'artifacts_artifactrecord', 'power_type')


        # Changing field 'ArtifactRecord.state'
        db.alter_column(u'artifacts_artifactrecord', 'state', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'ArtifactRecord.type'
        db.alter_column(u'artifacts_artifactrecord', 'type', self.gf('django.db.models.fields.IntegerField')())
