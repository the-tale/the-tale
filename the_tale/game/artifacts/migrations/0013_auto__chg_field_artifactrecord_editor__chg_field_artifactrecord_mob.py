...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ArtifactRecord.editor'
        db.alter_column(u'artifacts_artifactrecord', 'editor_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['accounts.Account']))

        # Changing field 'ArtifactRecord.mob'
        db.alter_column(u'artifacts_artifactrecord', 'mob_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['mobs.MobRecord']))

    def backwards(self, orm):

        # Changing field 'ArtifactRecord.editor'
        db.alter_column(u'artifacts_artifactrecord', 'editor_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.Account']))

        # Changing field 'ArtifactRecord.mob'
        db.alter_column(u'artifacts_artifactrecord', 'mob_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['mobs.MobRecord']))
    ...
    models = {
        ...
        u'artifacts.artifactrecord': {
            ...
            'rarity': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
