...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArtifactRecord.rare_effect'
        db.add_column(u'artifacts_artifactrecord', 'rare_effect',
                      self.gf('rels.django.RelationIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ArtifactRecord.epic_effect'
        db.add_column(u'artifacts_artifactrecord', 'epic_effect',
                      self.gf('rels.django.RelationIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArtifactRecord.rare_effect'
        db.delete_column(u'artifacts_artifactrecord', 'rare_effect')

        # Deleting field 'ArtifactRecord.epic_effect'
        db.delete_column(u'artifacts_artifactrecord', 'epic_effect')
