...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArtifactRecord.mob'
        db.add_column('artifacts_artifactrecord', 'mob',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['mobs.MobRecord']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ArtifactRecord.mob'
        db.delete_column('artifacts_artifactrecord', 'mob_id')
    ...
    models = {
        ...
        'artifacts.artifactrecord': {
            ...
            'mob': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['mobs.MobRecord']"}),
