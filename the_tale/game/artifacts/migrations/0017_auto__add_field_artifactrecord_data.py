...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArtifactRecord.data'
        db.add_column(u'artifacts_artifactrecord', 'data',
                      self.gf('django.db.models.fields.TextField')(default='{}'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArtifactRecord.data'
        db.delete_column(u'artifacts_artifactrecord', 'data')
