...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ArtifactRecord.min_level'
        db.delete_column('artifacts_artifactrecord', 'min_level')

    def backwards(self, orm):
        # Adding field 'ArtifactRecord.min_level'
        db.add_column('artifacts_artifactrecord', 'min_level',
