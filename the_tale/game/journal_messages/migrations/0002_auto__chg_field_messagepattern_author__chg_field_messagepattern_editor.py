...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MessagePattern.author'
        db.alter_column('journal_messages_messagepattern', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.Account']))

        # Changing field 'MessagePattern.editor'
        db.alter_column('journal_messages_messagepattern', 'editor_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.Account']))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'MessagePattern.author'
        raise RuntimeError("Cannot reverse this migration. 'MessagePattern.author' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'MessagePattern.editor'
        raise RuntimeError("Cannot reverse this migration. 'MessagePattern.editor' and its values cannot be restored.")
    ...
    models = {
        ...
        'journal_messages.messagepattern': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'proposed_journal_messages'", 'null': 'True', 'to': "orm['accounts.Account']"}),
            'comment': ('django.db.models.fields.TextField', [], {}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'editor': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'edited_journal_messages'", 'null': 'True', 'to': "orm['accounts.Account']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
