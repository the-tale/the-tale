...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'bank_account', (
            ...
            ('entity_type', self.gf('rels.django.RelationIntegerField')(db_index=True)),
            ('entity_id', self.gf('django.db.models.fields.BigIntegerField')()),
            ('currency', self.gf('rels.django.RelationIntegerField')(db_index=True)),
        ...
        db.create_table(u'bank_invoice', (
            ...
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('recipient_type', self.gf('rels.django.RelationIntegerField')(db_index=True)),
            ('recipient_id', self.gf('django.db.models.fields.BigIntegerField')()),
            ('sender_type', self.gf('rels.django.RelationIntegerField')(db_index=True)),
