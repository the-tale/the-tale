...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'dengionline_invoice', (
            ...
            ('state', self.gf('rels.django_staff.TableIntegerField')(null=True, db_index=True)),
            ('bank_type', self.gf('rels.django_staff.TableIntegerField')(db_index=True)),
            ('bank_id', self.gf('django.db.models.fields.BigIntegerField')()),
            ('bank_currency', self.gf('rels.django_staff.TableIntegerField')(db_index=True)),
            ...
            ('payment_currency', self.gf('rels.django_staff.TableIntegerField')(db_index=True)),
            ('received_amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2)),
            ('received_currency', self.gf('rels.django_staff.TableIntegerField')(null=True, db_index=True)),
