...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('postponed_tasks_postponedtask', 'comment', self.gf('django.db.models.fields.CharField')(max_length=256))
    def backwards(self, orm):

        # Changing field 'PostponedTask.comment'
        db.alter_column('postponed_tasks_postponedtask', 'comment', self.gf('django.db.models.fields.CharField')(max_length=64))
    models = {
