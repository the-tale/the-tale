...
from the_tale.accounts.payments.postponed_tasks import BuyRandomPremiumChest
...
@mock.patch('the_tale.accounts.payments.postponed_tasks.BuyRandomPremiumChest.get_reward_type',
            lambda self: relations.RANDOM_PREMIUM_CHEST_REWARD.ARTIFACT)
class BuyRandomPremiumChestTask__Artifact_Tests(base_buy_task._BaseBuyHeroMethodPosponedTaskTests):

    def setUp(self):
        super(BuyRandomPremiumChestTask__Artifact_Tests, self).setUp()
