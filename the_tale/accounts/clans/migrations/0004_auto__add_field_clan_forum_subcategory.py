...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Clan.forum_subcategory'
        db.add_column(u'clans_clan', 'forum_subcategory',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['forum.SubCategory'], null=True, on_delete=models.PROTECT),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Clan.forum_subcategory'
        db.delete_column(u'clans_clan', 'forum_subcategory_id')
