...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Clan.forum_subcategory'
        db.alter_column(u'clans_clan', 'forum_subcategory_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['forum.SubCategory'], on_delete=models.PROTECT))

    def backwards(self, orm):

        # Changing field 'Clan.forum_subcategory'
        db.alter_column(u'clans_clan', 'forum_subcategory_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forum.SubCategory'], null=True, on_delete=models.PROTECT))
