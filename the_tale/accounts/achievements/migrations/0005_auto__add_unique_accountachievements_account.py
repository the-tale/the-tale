...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'AccountAchievements', fields ['account']
        db.create_unique(u'achievements_accountachievements', ['account_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'AccountAchievements', fields ['account']
        db.delete_unique(u'achievements_accountachievements', ['account_id'])
