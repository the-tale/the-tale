...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Achievement.item_1'
        db.add_column(u'achievements_achievement', 'item_1',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', null=True, to=orm['collections.Item']),
                      keep_default=False)

        # Adding field 'Achievement.item_2'
        db.add_column(u'achievements_achievement', 'item_2',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', null=True, to=orm['collections.Item']),
                      keep_default=False)

        # Adding field 'Achievement.item_3'
        db.add_column(u'achievements_achievement', 'item_3',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', null=True, to=orm['collections.Item']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Achievement.item_1'
        db.delete_column(u'achievements_achievement', 'item_1_id')

        # Deleting field 'Achievement.item_2'
        db.delete_column(u'achievements_achievement', 'item_2_id')

        # Deleting field 'Achievement.item_3'
        db.delete_column(u'achievements_achievement', 'item_3_id')
    ...
    models = {
        ...
        u'achievements.achievement': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item_1': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'+'", 'null': 'True', 'to': u"orm['collections.Item']"}),
            'item_2': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'+'", 'null': 'True', 'to': u"orm['collections.Item']"}),
            'item_3': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'+'", 'null': 'True', 'to': u"orm['collections.Item']"}),
