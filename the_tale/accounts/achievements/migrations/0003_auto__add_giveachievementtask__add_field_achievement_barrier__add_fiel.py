...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GiveAchievementTask'
        db.create_table(u'achievements_giveachievementtask', (
        ...
        db.send_create_signal(u'achievements', ['GiveAchievementTask'])

        # Adding field 'Achievement.barrier'
        db.add_column(u'achievements_achievement', 'barrier',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Achievement.points'
        db.add_column(u'achievements_achievement', 'points',
                      self.gf('django.db.models.fields.IntegerField')(default=10),
                      keep_default=False)

        # Adding field 'AccountAchievements.points'
        db.add_column(u'achievements_accountachievements', 'points',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'GiveAchievementTask'
        db.delete_table(u'achievements_giveachievementtask')

        # Deleting field 'Achievement.barrier'
        db.delete_column(u'achievements_achievement', 'barrier')

        # Deleting field 'Achievement.points'
        db.delete_column(u'achievements_achievement', 'points')

        # Deleting field 'AccountAchievements.points'
        db.delete_column(u'achievements_accountachievements', 'points')
