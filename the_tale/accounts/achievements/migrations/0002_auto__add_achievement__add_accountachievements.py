...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AccountAchievements'
        db.create_table(u'achievements_accountachievements', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Account'])),
            ('achievements', self.gf('django.db.models.fields.TextField')(default='{}')),
        ))
        db.send_create_signal(u'achievements', ['AccountAchievements'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'AccountAchievements'
        db.delete_table(u'achievements_accountachievements')
