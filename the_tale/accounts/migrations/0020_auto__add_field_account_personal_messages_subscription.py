...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.personal_messages_subscription'
        db.add_column(u'accounts_account', 'personal_messages_subscription',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Account.personal_messages_subscription'
        db.delete_column(u'accounts_account', 'personal_messages_subscription')
