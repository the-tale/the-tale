...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.last_news_remind_time'
        db.add_column('accounts_account', 'last_news_remind_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0)),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Account.last_news_remind_time'
        db.delete_column('accounts_account', 'last_news_remind_time')
