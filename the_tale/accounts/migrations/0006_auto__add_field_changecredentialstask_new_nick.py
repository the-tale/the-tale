...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChangeCredentialsTask.new_nick'
        db.add_column('accounts_changecredentialstask', 'new_nick',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=30, null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ChangeCredentialsTask.new_nick'
        db.delete_column('accounts_changecredentialstask', 'new_nick')
