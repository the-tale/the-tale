...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.new_messages_number'
        db.add_column('accounts_account', 'new_messages_number',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Account.new_messages_number'
        db.delete_column('accounts_account', 'new_messages_number')
