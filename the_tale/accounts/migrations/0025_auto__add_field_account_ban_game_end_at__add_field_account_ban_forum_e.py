...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.ban_game_end_at'
        db.add_column(u'accounts_account', 'ban_game_end_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0), db_index=True),
                      keep_default=False)

        # Adding field 'Account.ban_forum_end_at'
        db.add_column(u'accounts_account', 'ban_forum_end_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0), db_index=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Account.ban_game_end_at'
        db.delete_column(u'accounts_account', 'ban_game_end_at')

        # Deleting field 'Account.ban_forum_end_at'
        db.delete_column(u'accounts_account', 'ban_forum_end_at')
