...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.premium_end_at'
        db.add_column(u'accounts_account', 'premium_end_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0), db_index=True),
                      keep_default=False)

        # Adding field 'Account.active_end_at'
        db.add_column(u'accounts_account', 'active_end_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 5, 6, 0, 0), db_index=True),
                      keep_default=False)


        # Changing field 'ChangeCredentialsTask.state'
        db.alter_column(u'accounts_changecredentialstask', 'state', self.gf('rels.django_staff.TableIntegerField')())
    def backwards(self, orm):
        # Deleting field 'Account.premium_end_at'
        db.delete_column(u'accounts_account', 'premium_end_at')

        # Deleting field 'Account.active_end_at'
        db.delete_column(u'accounts_account', 'active_end_at')


        # Changing field 'ChangeCredentialsTask.state'
        db.alter_column(u'accounts_changecredentialstask', 'state', self.gf('django.db.models.fields.IntegerField')())
    models = {
        u'accounts.account': {
