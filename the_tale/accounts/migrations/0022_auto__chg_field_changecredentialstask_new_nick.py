...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ChangeCredentialsTask.new_nick'
        db.alter_column(u'accounts_changecredentialstask', 'new_nick', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))
    def backwards(self, orm):

        # Changing field 'ChangeCredentialsTask.new_nick'
        db.alter_column(u'accounts_changecredentialstask', 'new_nick', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
    models = {
        u'accounts.account': {
