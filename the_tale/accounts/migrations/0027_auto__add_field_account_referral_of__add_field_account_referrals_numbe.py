...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.referral_of'
        db.add_column(u'accounts_account', 'referral_of',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['accounts.Account'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'Account.referrals_number'
        db.add_column(u'accounts_account', 'referrals_number',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Account.referral_of'
        db.delete_column(u'accounts_account', 'referral_of_id')

        # Deleting field 'Account.referrals_number'
        db.delete_column(u'accounts_account', 'referrals_number')
