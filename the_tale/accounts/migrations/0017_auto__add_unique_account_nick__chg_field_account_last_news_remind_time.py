...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Account', fields ['nick']
        db.create_unique(u'accounts_account', ['nick'])


        # Changing field 'Account.last_news_remind_time'
        db.alter_column(u'accounts_account', 'last_news_remind_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    def backwards(self, orm):
        # Removing unique constraint on 'Account', fields ['nick']
        db.delete_unique(u'accounts_account', ['nick'])


        # Changing field 'Account.last_news_remind_time'
        db.alter_column(u'accounts_account', 'last_news_remind_time', self.gf('django.db.models.fields.DateTimeField')())
    models = {
        u'accounts.account': {
