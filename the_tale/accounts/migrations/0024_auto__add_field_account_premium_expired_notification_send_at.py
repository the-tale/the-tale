...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.premium_expired_notification_send_at'
        db.add_column(u'accounts_account', 'premium_expired_notification_send_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0), db_index=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Account.premium_expired_notification_send_at'
        db.delete_column(u'accounts_account', 'premium_expired_notification_send_at')
