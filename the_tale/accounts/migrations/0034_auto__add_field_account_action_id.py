...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.action_id'
        db.add_column(u'accounts_account', 'action_id',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=128, null=True, db_index=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.action_id'
        db.delete_column(u'accounts_account', 'action_id')
