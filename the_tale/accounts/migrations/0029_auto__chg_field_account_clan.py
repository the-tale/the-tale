...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Account.clan'
        db.alter_column(u'accounts_account', 'clan_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['clans.Clan']))

    def backwards(self, orm):

        # Changing field 'Account.clan'
        db.alter_column(u'accounts_account', 'clan_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['clans.Clan']))
