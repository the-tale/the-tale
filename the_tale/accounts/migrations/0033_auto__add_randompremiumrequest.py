...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RandomPremiumRequest'
        db.create_table(u'accounts_randompremiumrequest', (
            ...
            ('initiator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', on_delete=models.PROTECT, to=orm['accounts.Account'])),
            ('receiver', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', null=True, on_delete=models.PROTECT, to=orm['accounts.Account'])),
        ))
        db.send_create_signal(u'accounts', ['RandomPremiumRequest'])


    def backwards(self, orm):
        # Deleting model 'RandomPremiumRequest'
        db.delete_table(u'accounts_randompremiumrequest')
    ...
    models = {
        ...
        u'accounts.randompremiumrequest': {
            'Meta': {'object_name': 'RandomPremiumRequest'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'days': ('django.db.models.fields.IntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'initiator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'on_delete': 'models.PROTECT', 'to': u"orm['accounts.Account']"}),
            'receiver': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': u"orm['accounts.Account']"}),
            'state': ('rels.django.RelationIntegerField', [], {'db_index': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'db_index': 'True', 'blank': 'True'})
        },
