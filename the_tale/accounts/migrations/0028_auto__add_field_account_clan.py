...
class Migration(SchemaMigration):
    ...
    depends_on = ( ("clans", "0001_initial"), )

    def forwards(self, orm):
        # Adding field 'Account.clan'
        db.add_column(u'accounts_account', 'clan',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', null=True, to=orm['clans.Clan']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.clan'
        db.delete_column(u'accounts_account', 'clan_id')
    ...
    models = {
        u'accounts.account': {
            ...
            'clan': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'+'", 'null': 'True', 'to': u"orm['clans.Clan']"}),
