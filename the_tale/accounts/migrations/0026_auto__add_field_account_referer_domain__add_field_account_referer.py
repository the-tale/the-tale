...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.referer_domain'
        db.add_column(u'accounts_account', 'referer_domain',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=256, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Account.referer'
        db.add_column(u'accounts_account', 'referer',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=4096, null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Account.referer_domain'
        db.delete_column(u'accounts_account', 'referer_domain')

        # Deleting field 'Account.referer'
        db.delete_column(u'accounts_account', 'referer')
