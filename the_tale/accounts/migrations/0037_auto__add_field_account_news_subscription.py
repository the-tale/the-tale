...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.news_subscription'
        db.add_column(u'accounts_account', 'news_subscription',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.news_subscription'
        db.delete_column(u'accounts_account', 'news_subscription')
