...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Award.type'
        db.alter_column(u'accounts_award', 'type', self.gf('rels.django_staff.TableIntegerField')())
        # Adding index on 'Award', fields ['type']
        db.create_index(u'accounts_award', ['type'])

    def backwards(self, orm):
        # Removing index on 'Award', fields ['type']
        db.delete_index(u'accounts_award', ['type'])


        # Changing field 'Award.type'
        db.alter_column(u'accounts_award', 'type', self.gf('django.db.models.fields.IntegerField')())
    models = {
        u'accounts.account': {
