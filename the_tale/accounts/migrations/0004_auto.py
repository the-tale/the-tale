...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Account', fields ['is_fast']
        db.create_index('accounts_account', ['is_fast'])

    def backwards(self, orm):
        # Removing index on 'Account', fields ['is_fast']
        db.delete_index('accounts_account', ['is_fast'])
