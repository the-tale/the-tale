...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'third_party_accesstoken', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['accounts.Account'], null=True)),
            ('uid', self.gf('the_tale.common.utils.models.UUIDField')(unique=True, max_length=36, db_index=True)),
            ('application_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('application_info', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('application_description', self.gf('django.db.models.fields.TextField')()),
            ('state', self.gf('rels.django.RelationIntegerField')()),
        ))
        db.send_create_signal(u'third_party', ['AccessToken'])


    def backwards(self, orm):
        # Deleting model 'AccessToken'
        db.delete_table(u'third_party_accesstoken')
    ...
    models = {
        ...
        u'third_party.accesstoken': {
            'Meta': {'object_name': 'AccessToken'},
            'account': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['accounts.Account']", 'null': 'True'}),
            'application_description': ('django.db.models.fields.TextField', [], {}),
            'application_info': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'application_name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
