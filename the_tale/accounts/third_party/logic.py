...
def remove_expired_access_tokens():
    live_time = datetime.timedelta(minutes=third_party_settings.UNACCEPTED_ACCESS_TOKEN_LIVE_TIME)

    prototypes.AccessTokenPrototype._db_filter(state=relations.ACCESS_TOKEN_STATE.UNACCEPTED,
