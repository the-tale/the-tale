...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'friends_friendship', (
            ...
            ('friend_1', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['accounts.Account'])),
            ('friend_2', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['accounts.Account'])),
            ('text', self.gf('django.db.models.fields.TextField')(default=u'\u0414\u0430\u0432\u0430\u0439\u0442\u0435 \u0434\u0440\u0443\u0436\u0438\u0442\u044c')),
    ...
    models = {
        ...
        u'friends.friendship': {
            ...
            'friend_1': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': u"orm['accounts.Account']"}),
            'friend_2': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': u"orm['accounts.Account']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_confirmed': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'text': ('django.db.models.fields.TextField', [], {'default': "u'\\u0414\\u0430\\u0432\\u0430\\u0439\\u0442\\u0435 \\u0434\\u0440\\u0443\\u0436\\u0438\\u0442\\u044c'"})
        }
    }
