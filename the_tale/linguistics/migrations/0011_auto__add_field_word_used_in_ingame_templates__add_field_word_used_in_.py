...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Word.used_in_ingame_templates'
        db.add_column(u'linguistics_word', 'used_in_ingame_templates',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Word.used_in_onreview_templates'
        db.add_column(u'linguistics_word', 'used_in_onreview_templates',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Word.used_in_status'
        db.add_column(u'linguistics_word', 'used_in_status',
                      self.gf('rels.django.RelationIntegerField')(default=2, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Word.used_in_ingame_templates'
        db.delete_column(u'linguistics_word', 'used_in_ingame_templates')

        # Deleting field 'Word.used_in_onreview_templates'
        db.delete_column(u'linguistics_word', 'used_in_onreview_templates')

        # Deleting field 'Word.used_in_status'
        db.delete_column(u'linguistics_word', 'used_in_status')
