...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Restriction', fields ['name']
        db.delete_unique(u'linguistics_restriction', ['name'])


    def backwards(self, orm):
        # Adding unique constraint on 'Restriction', fields ['name']
        db.create_unique(u'linguistics_restriction', ['name'])
