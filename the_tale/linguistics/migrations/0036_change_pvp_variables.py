...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for template in orm['linguistics.Template'].objects.filter(key__in=(340000, 340001, 340002, 340003, 340004, 320000)).all():
             template.raw_template = template.raw_template.replace(u'hero', u'duelist_1')
             template.data = template.data.replace(u'hero', u'duelist_1')
             template.save()
