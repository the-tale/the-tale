...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contribution.source'
        db.add_column(u'linguistics_contribution', 'source',
                      self.gf('rels.django.RelationIntegerField')(default=0, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contribution.source'
        db.delete_column(u'linguistics_contribution', 'source')
