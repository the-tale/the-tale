...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Template.errors_status'
        db.add_column(u'linguistics_template', 'errors_status',
                      self.gf('rels.django.RelationIntegerField')(default=0, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Template.errors_status'
        db.delete_column(u'linguistics_template', 'errors_status')
