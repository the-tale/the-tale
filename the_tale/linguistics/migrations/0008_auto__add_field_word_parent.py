...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Word.parent'
        db.add_column(u'linguistics_word', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['linguistics.Word'], null=True, on_delete=models.SET_NULL),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Word.parent'
        db.delete_column(u'linguistics_word', 'parent_id')
