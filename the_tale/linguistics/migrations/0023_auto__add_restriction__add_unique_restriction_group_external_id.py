...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'linguistics_restriction', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=128)),
            ('group', self.gf('rels.django.RelationIntegerField')(db_index=True)),
            ('external_id', self.gf('django.db.models.fields.BigIntegerField')(db_index=True)),
        ))
        db.send_create_signal(u'linguistics', ['Restriction'])

        # Adding unique constraint on 'Restriction', fields ['group', 'external_id']
        db.create_unique(u'linguistics_restriction', ['group', 'external_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Restriction', fields ['group', 'external_id']
        db.delete_unique(u'linguistics_restriction', ['group', 'external_id'])

        # Deleting model 'Restriction'
        db.delete_table(u'linguistics_restriction')
