...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Template', fields ['raw_template']
        db.create_index(u'linguistics_template', ['raw_template'])

        # Adding index on 'Contribution', fields ['created_at']
        db.create_index(u'linguistics_contribution', ['created_at'])


    def backwards(self, orm):
        # Removing index on 'Contribution', fields ['created_at']
        db.delete_index(u'linguistics_contribution', ['created_at'])

        # Removing index on 'Template', fields ['raw_template']
        db.delete_index(u'linguistics_template', ['raw_template'])
