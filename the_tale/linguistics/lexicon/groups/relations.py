...
class LEXICON_GROUP(DjangoEnum):
    ...
    records = (('ACTION_BATTLEPVE1X1', 0, u'Действие: Сражение с монстром', 0,
               ...
               ('ACTION_REST', 9, u'Действие: отдых', 90000,
               u'Описание действий во время отдыха героя.',
               ...
               {V.HERO: u'герой', V.DROPPED_ITEM: u'выкидываемый предмет', V.ENERGY: u'энергия', V.COINS: u'количество монет', V.EXPERIENCE: u'количество опыта', V.HEALTH: u'количество здоровья', V.MOB: u'монстр'}),

               ('CHRONICLE', 13, u'Летопись', 130000,
               u'Фразы, употребляющиеся в летописи.',
               {V.NEW_NAME: u'новое название', V.NEW_RACE: u'новая раса города', V.DECLINED_BILL: u'название отменяемого закона', V.PERSON: u'житель города', V.RESOURCE_2: u'второй ресурс', V.RESOURCE_1: u'первый ресурс', V.BILL: u'название закона', V.PLACE_2: u'второй город ', V.PLACE_1: u'первый город', V.PLACE: u'название города', V.OLD_NAME: u'старое название', V.OLD_RACE: u'старая раса города', V.NEW_MODIFIER: u'новая специализация города', V.OLD_MODIFIER: u'старая специализация города'}),

               ('HERO_ABILITY', 14, u'Способности: герой', 140000,
               u'Описание применения способностей героем (или монстром)',
               {V.ATTACKER: u'атакующий', V.HEALTH: u'количество вылеченного здоровья', V.DAMAGE: u'количество урона', V.ACTOR: u'герой или монстр', V.DEFENDER: u'защищающийся'}),

               ('HERO_COMMON', 15, u'Общие сообщения, относящиеся к герою', 150000,
               u'Сообщение, относящиеся к герою и не вошедшие в другие модули',
               {V.HERO: u'герой', V.LEVEL: u'уровень'}),
