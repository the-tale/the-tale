...
class LEXICON_GROUP(DjangoEnum):
    ...
    records = (('ACTION_BATTLEPVE1X1', 0, u'Действие: сражение с монстром', 0,
               ...
               {V.COMPANION_OWNER: u'владелец спутника', V.COMPANION: u'спутник', V.ATTACKER: u'атакущий спутника', V.COINS: u'вырученные средства', V.EXPERIENCE: u'опыт', V.HEALTH: u'количество здоровья'}),
               ...
               {V.COMPANION_OWNER: u'владелец спутника', V.COMPANION: u'спутник', V.HEALTH: u'количество здоровья'}),
               )
