...
KEYS = [(u'CHRONICLE_BILL_DECLINE_BILL_FAILED', 260000, u'Отмена закона: отклонён закон', LEXICON_GROUP.CHRONICLE,
        ...
        (u'CHRONICLE_PLACE_CHANGE_MODIFIER_BILL_SUCCESSED_WITH_OLD_MODIFIER', 260025, u'Специализация города: принят закон об изменении', LEXICON_GROUP.CHRONICLE,
        u'Принят закон об изменении специализации города (установлена новая специализация).',
        [V.NEW_MODIFIER, V.BILL, V.PLACE, V.OLD_MODIFIER]),

        (u'CHRONICLE_PLACE_CHANGE_MODIFIER_BILL_SUCCESSED_WITHOUT_OLD_MODIFIER', 260026, u'Специализация города: принят закон об установке', LEXICON_GROUP.CHRONICLE,
        ...
        (u'CHRONICLE_PLACE_RESOURCE_CONVERSION_BILL_ENDED', 260032, u'Изменение параметров города: истёк срок действия закона об изменении параметров города', LEXICON_GROUP.CHRONICLE,
        u'Истёк срок действия закона об изменении параметров города.',
        ...
        (u'CHRONICLE_PLACE_RESOURCE_EXCHANGE_BILL_ENDED', 260036, u'Обмен ресурсами: истёк срок действия закона об обмене ресурами', LEXICON_GROUP.CHRONICLE,
        u'Истёк срок действия закона об обмене ресурсами между городами.',
