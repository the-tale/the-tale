...
KEYS = [(u'ANGEL_ABILITY_ARENA_PVP_1X1', 240000, u'Журнал: Отправка на PvP арену', LEXICON_GROUP.ANGEL_ABILITY,
        ...
        [V.DROPPED_ITEM, V.COINS, V.HERO], u'hero#N +coins#G'),

        (u'ANGEL_ABILITY_EXPERIENCE', 240006, u'Журнал: Получение опыта', LEXICON_GROUP.ANGEL_ABILITY,
        u'Получение опыта.',
        [V.HERO, V.EXPERIENCE], u'hero#N +experience#EXP'),
        ...
        u'Герой находит существенное количество монет.',
        [V.COINS, V.HERO], u'hero#N +coins#G'),
        ...
        u'Игрок запасает бонусную энергию.',
        [V.ENERGY, V.HERO], u'hero#N +energy#EN'),
        ...
        [V.HEALTH, V.HERO, V.COMPANION, V.HEALTH], u'companion#N +health#HP'),
