...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Page', fields ['section', 'order']
        db.create_unique('cms_page', ['section', 'order'])

    def backwards(self, orm):
        # Removing unique constraint on 'Page', fields ['section', 'order']
        db.delete_unique('cms_page', ['section', 'order'])
    ...
    models = {
        ...
        'cms.page': {
            ...
            'editor': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'+'", 'null': 'True', 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
