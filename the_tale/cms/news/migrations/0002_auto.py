...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'News', fields ['created_at']
        db.create_index('news_news', ['created_at'])

    def backwards(self, orm):
        # Removing index on 'News', fields ['created_at']
        db.delete_index('news_news', ['created_at'])
