...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'News.forum_thread'
        db.add_column('news_news', 'forum_thread', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forum.Thread'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'News.forum_thread'
        db.delete_column('news_news', 'forum_thread_id')
    ...
    models = {
        ...
        'news.news': {
            ...
            'forum_thread': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['forum.Thread']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        }
    }
