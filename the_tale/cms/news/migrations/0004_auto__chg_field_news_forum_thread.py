...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'News.forum_thread'
        db.alter_column(u'news_news', 'forum_thread_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forum.Thread'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'News.forum_thread'
        db.alter_column(u'news_news', 'forum_thread_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forum.Thread'], null=True))
    ...
    models = {
        ...
        u'news.news': {
            ...
            'forum_thread': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['forum.Thread']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        }
    }
