...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'SubCategory', fields ['slug']
        db.create_index('forum_subcategory', ['slug'])

        # Adding field 'Thread.updated_at'
        db.add_column('forum_thread', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2000, 1, 1, 0, 0), auto_now_add=True, blank=True), keep_default=False)

        # Adding index on 'Category', fields ['slug']
        db.create_index('forum_category', ['slug'])


    def backwards(self, orm):
        
        # Removing index on 'Category', fields ['slug']
        db.delete_index('forum_category', ['slug'])

        # Removing index on 'SubCategory', fields ['slug']
        db.delete_index('forum_subcategory', ['slug'])

        # Deleting field 'Thread.updated_at'
        db.delete_column('forum_thread', 'updated_at')
