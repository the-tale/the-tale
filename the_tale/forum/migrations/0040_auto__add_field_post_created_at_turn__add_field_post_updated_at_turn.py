...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.created_at_turn'
        db.add_column(u'forum_post', 'created_at_turn',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Post.updated_at_turn'
        db.add_column(u'forum_post', 'updated_at_turn',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.created_at_turn'
        db.delete_column(u'forum_post', 'created_at_turn')

        # Deleting field 'Post.updated_at_turn'
        db.delete_column(u'forum_post', 'updated_at_turn')
