...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.state'
        db.add_column('forum_post', 'state',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Post.removed_by'
        db.add_column('forum_post', 'removed_by',
    ...
    def backwards(self, orm):
        # Deleting field 'Post.state'
        db.delete_column('forum_post', 'state')

        # Deleting field 'Post.removed_by'
        db.delete_column('forum_post', 'removed_by')
