...
GAME_START_TIME = datetime.datetime(year=2013, month=6, day=29)
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for post_id, created_at, updated_at in Post.objects.all().values_list('id', 'created_at', 'updated_at'):
            created_at_turn = (created_at - GAME_START_TIME).total_seconds() / 10
            updated_at_turn = (updated_at - GAME_START_TIME).total_seconds() / 10 if updated_at else 0
            Post.objects.filter(id=post_id).update(created_at_turn=created_at_turn,
    ...
    models = {
        ...
        u'forum.post': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'forum_posts'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['accounts.Account']"}),
