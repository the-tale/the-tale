...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubCategory.last_thread'
        db.add_column(u'forum_subcategory', 'last_thread',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['forum.Thread']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubCategory.last_thread'
        db.delete_column(u'forum_subcategory', 'last_thread_id')
