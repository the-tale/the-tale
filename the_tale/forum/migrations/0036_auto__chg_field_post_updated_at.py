...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'forum_post', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))

    def backwards(self, orm):

        # Changing field 'Post.updated_at'
        db.alter_column(u'forum_post', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
