...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'forum_subscription', (
            ...
            ('thread', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['forum.Thread'])),
        ))
        db.send_create_signal(u'forum', ['Subscription'])

        # Adding unique constraint on 'Subscription', fields ['account', 'thread']
        db.create_unique(u'forum_subscription', ['account_id', 'thread_id'])

    def backwards(self, orm):
        # Removing unique constraint on 'Subscription', fields ['account', 'thread']
        db.delete_unique(u'forum_subscription', ['account_id', 'thread_id'])

        # Deleting model 'Subscription'
        db.delete_table(u'forum_subscription')
