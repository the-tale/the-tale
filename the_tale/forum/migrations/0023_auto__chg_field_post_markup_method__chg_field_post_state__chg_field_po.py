...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'forum_post', 'markup_method', self.gf('rels.django.RelationIntegerField')())

        # Changing field 'Post.state'
        db.alter_column(u'forum_post', 'state', self.gf('rels.django.RelationIntegerField')())

        # Changing field 'Post.removed_by'
        db.alter_column(u'forum_post', 'removed_by', self.gf('rels.django.RelationIntegerField')(null=True))
    def backwards(self, orm):

        # Changing field 'Post.markup_method'
        db.alter_column(u'forum_post', 'markup_method', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Post.state'
        db.alter_column(u'forum_post', 'state', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Post.removed_by'
        db.alter_column(u'forum_post', 'removed_by', self.gf('django.db.models.fields.IntegerField')(null=True))
    models = {
        u'accounts.account': {
