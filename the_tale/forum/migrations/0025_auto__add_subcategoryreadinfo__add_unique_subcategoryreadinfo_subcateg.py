...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SubCategoryReadInfo'
        db.create_table(u'forum_subcategoryreadinfo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('subcategory', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forum.SubCategory'])),
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['accounts.Account'])),
            ('all_read_at', self.gf('django.db.models.fields.DateTimeField')()),
            ('read_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'forum', ['SubCategoryReadInfo'])

        # Adding unique constraint on 'SubCategoryReadInfo', fields ['subcategory', 'account']
        db.create_unique(u'forum_subcategoryreadinfo', ['subcategory_id', 'account_id'])

        # Adding field 'SubCategory.last_thread_created_at'
        db.add_column(u'forum_subcategory', 'last_thread_created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Removing unique constraint on 'SubCategoryReadInfo', fields ['subcategory', 'account']
        db.delete_unique(u'forum_subcategoryreadinfo', ['subcategory_id', 'account_id'])

        # Deleting model 'SubCategoryReadInfo'
        db.delete_table(u'forum_subcategoryreadinfo')

        # Deleting field 'SubCategory.last_thread_created_at'
        db.delete_column(u'forum_subcategory', 'last_thread_created_at')
