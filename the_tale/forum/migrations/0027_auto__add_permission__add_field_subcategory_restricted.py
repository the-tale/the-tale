...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'forum_permission', (
            ...
            ('subcategory', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['forum.SubCategory'])),
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['accounts.Account'])),
        ))
        db.send_create_signal(u'forum', ['Permission'])

        # Adding field 'SubCategory.restricted'
        db.add_column(u'forum_subcategory', 'restricted',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'forum_permission')

        # Deleting field 'SubCategory.restricted'
        db.delete_column(u'forum_subcategory', 'restricted')
