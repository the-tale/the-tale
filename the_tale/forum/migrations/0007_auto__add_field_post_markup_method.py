...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Post.markup_method'
        db.add_column('forum_post', 'markup_method', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Post.markup_method'
        db.delete_column('forum_post', 'markup_method')
