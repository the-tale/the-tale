...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubCategory.last_poster'
        db.add_column('forum_subcategory', 'last_poster',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['accounts.Account']),
                      keep_default=False)

        # Adding field 'Thread.author'
        db.add_column('forum_thread', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['accounts.Account']),
                      keep_default=False)

        # Adding field 'Thread.last_poster'
        db.add_column('forum_thread', 'last_poster',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['accounts.Account']),
                      keep_default=False)

        # Adding field 'Post.author'
        db.add_column('forum_post', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['accounts.Account']),
                      keep_default=False)

        # Adding field 'Post.remove_initiator'
        db.add_column('forum_post', 'remove_initiator',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['accounts.Account']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'SubCategory.last_poster'
        db.delete_column('forum_subcategory', 'last_poster_id')

        # Deleting field 'Thread.author'
        db.delete_column('forum_thread', 'author_id')

        # Deleting field 'Thread.last_poster'
        db.delete_column('forum_thread', 'last_poster_id')

        # Deleting field 'Post.author'
        db.delete_column('forum_post', 'author_id')

        # Deleting field 'Post.remove_initiator'
        db.delete_column('forum_post', 'remove_initiator_id')
