...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubCategory.uid'
        db.add_column(u'forum_subcategory', 'uid',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=16, null=True, db_index=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubCategory.uid'
        db.delete_column(u'forum_subcategory', 'uid')
