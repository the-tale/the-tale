...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Permission', fields ['account', 'subcategory']
        db.create_unique(u'forum_permission', ['account_id', 'subcategory_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Permission', fields ['account', 'subcategory']
        db.delete_unique(u'forum_permission', ['account_id', 'subcategory_id'])
    ...
    models = {
        ...
        u'clans.clan': {
            ...
            'forum_subcategory': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['forum.SubCategory']", 'null': 'True', 'on_delete': 'models.PROTECT'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'forum.permission': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'subcategory': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': u"orm['forum.SubCategory']"}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'db_index': 'True', 'blank': 'True'})
        },
        u'forum.post': {
