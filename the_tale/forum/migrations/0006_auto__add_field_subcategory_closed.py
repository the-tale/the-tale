...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubCategory.closed'
        db.add_column('forum_subcategory', 'closed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SubCategory.closed'
        db.delete_column('forum_subcategory', 'closed')
