...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('forum_subcategory', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2000, 1, 1, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'Thread.created_at'
        db.add_column('forum_thread', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2000, 1, 1, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'SubCategory.created_at'
        db.delete_column('forum_subcategory', 'created_at')

        # Deleting field 'Thread.created_at'
        db.delete_column('forum_thread', 'created_at')
