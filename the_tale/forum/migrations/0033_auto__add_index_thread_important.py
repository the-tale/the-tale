...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Thread', fields ['important']
        db.create_index(u'forum_thread', ['important'])


    def backwards(self, orm):
        # Removing index on 'Thread', fields ['important']
        db.delete_index(u'forum_thread', ['important'])
