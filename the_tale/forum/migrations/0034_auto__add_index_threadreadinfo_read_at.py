...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'ThreadReadInfo', fields ['read_at']
        db.create_index(u'forum_threadreadinfo', ['read_at'])


    def backwards(self, orm):
        # Removing index on 'ThreadReadInfo', fields ['read_at']
        db.delete_index(u'forum_threadreadinfo', ['read_at'])
