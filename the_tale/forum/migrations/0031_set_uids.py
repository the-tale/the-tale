...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        orm['forum.SubCategory'].objects.filter(id=7).update(uid='bills')
        orm['forum.SubCategory'].objects.filter(id=1).update(uid='news')
        orm['forum.SubCategory'].objects.filter(id=9).update(uid='folclor')
