...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm['forum.SubCategory'].objects.all().update(user_last_poster=models.F('last_poster'))

        orm['forum.Thread'].objects.all().update(user_last_poster=models.F('last_poster'))
        orm['forum.Thread'].objects.all().update(user_author=models.F('author'))

        orm['forum.Post'].objects.all().update(user_author=models.F('author'))
        orm['forum.Post'].objects.all().update(user_remove_initiator=models.F('remove_initiator'))
