...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubCategory.order'
        db.add_column('forum_subcategory', 'order', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)

        # Adding field 'Category.order'
        db.add_column('forum_category', 'order', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SubCategory.order'
        db.delete_column('forum_subcategory', 'order')

        # Deleting field 'Category.order'
        db.delete_column('forum_category', 'order')
