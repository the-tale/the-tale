...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Lot.buyer'
        db.alter_column(u'market_lot', 'buyer_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['accounts.Account'], null=True))
        # Adding index on 'Lot', fields ['created_at']
        db.create_index(u'market_lot', ['created_at'])


    def backwards(self, orm):
        # Removing index on 'Lot', fields ['created_at']
        db.delete_index(u'market_lot', ['created_at'])


        # Changing field 'Lot.buyer'
        db.alter_column(u'market_lot', 'buyer_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.Account']))
