...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Lot.updated_at'
        db.delete_column(u'market_lot', 'updated_at')

        # Adding field 'Lot.closed_at'
        db.add_column(u'market_lot', 'closed_at',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Lot.updated_at'
        raise RuntimeError("Cannot reverse this migration. 'Lot.updated_at' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Lot.updated_at'
        db.add_column(u'market_lot', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True),
                      keep_default=False)

        # Deleting field 'Lot.closed_at'
        db.delete_column(u'market_lot', 'closed_at')
