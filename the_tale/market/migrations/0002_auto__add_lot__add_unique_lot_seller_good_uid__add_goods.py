...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Lot'
        db.create_table(u'market_lot', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=16, db_index=True)),
            ('good_uid', self.gf('django.db.models.fields.CharField')(max_length=64, db_index=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128, db_index=True)),
            ('seller', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['accounts.Account'])),
            ('buyer', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', null=True, blank=True, to=orm['accounts.Account'])),
        ...
        db.send_create_signal(u'market', ['Lot'])

        # Adding unique constraint on 'Lot', fields ['seller', 'good_uid']
        db.create_unique(u'market_lot', ['seller_id', 'good_uid'])

        # Adding model 'Goods'
        db.create_table(u'market_goods', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ...
        db.send_create_signal(u'market', ['Goods'])


    def backwards(self, orm):
        # Removing unique constraint on 'Lot', fields ['seller', 'good_uid']
        db.delete_unique(u'market_lot', ['seller_id', 'good_uid'])

        # Deleting model 'Lot'
        db.delete_table(u'market_lot')

        # Deleting model 'Goods'
        db.delete_table(u'market_goods')
    ...
    models = {
        ...
        u'market.lot': {
            ...
            'buyer': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'+'", 'null': 'True', 'blank': 'True', 'to': u"orm['accounts.Account']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'data': ('django.db.models.fields.TextField', [], {'default': "'{}'"}),
