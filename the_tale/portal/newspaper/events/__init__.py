...
from portal.newspaper.events.bills import EventBillCreated, EventBillEdited, EventBillProcessed
from portal.newspaper.events.heroes import EventHeroOfTheDay

EVENTS = [EventBillCreated, EventBillEdited, EventBillProcessed, EventHeroOfTheDay]
