...
class NewspaperEvent(models.Model):
    ...
    section = models.IntegerField(null=False, choices=NEWSPAPER_EVENT_SECTION.CHOICES, db_index=True)

    type = models.IntegerField(null=True, choices=NEWSPAPER_EVENT_TYPE.CHOICES, db_index=True)
