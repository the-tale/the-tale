...
class PortalResource(Resource):
    ...
    def handlerCSRF(self, reason=u''):
        return self.auto_error('common.csrf',
                               u'Неверный csrf токен. Если Вы разработчик, проверьте формирование своего запроса. Если Вы обычный игрок, возможно, Вы случайно разлогинились, нашли ошибку в игре или Вас пытаются «хакнуть». [%s]' % reason,
                               status_code=403)
